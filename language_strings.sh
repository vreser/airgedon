...
function language_strings() {
	...
	arr["ENGLISH",450]="3.  Enable extended colorization permanently"
	arr["SPANISH",450]="3.  Habilitar permanentemente la colorización extendida"
	arr["FRENCH",450]="${pending_of_translation} 3.  Activer dé façon permanante la colorisation étendue"
	arr["CATALAN",450]="${pending_of_translation} 3.  Habilita permanentment la coloració estesa"
	arr["PORTUGUESE",450]="${pending_of_translation} 3.  Ativar permanentemente a colorização estendida"
	arr["RUSSIAN",450]="${pending_of_translation} 3.  Включить расширенную раскраску навсегда"
	arr["GREEK",450]="${pending_of_translation} 3.  Ενεργοποιήστε τον εκτεταμένο χρωματισμό μόνιμα"
	arr["ITALIAN",450]="${pending_of_translation} 3.  Abilitare permanentemente la colorazione estesa"
	arr["POLISH",450]="${pending_of_translation} 3.  Trwale włącz przedłużona kolorowanie"
	arr["GERMAN",450]="${pending_of_translation} 3.  Die erweiterte Einfärbung dauerhaft aktivieren"
	arr["TURKISH",450]="${pending_of_translation} 3.  Genişletilmiş renklendirmeyi kalıcı olarak etkinleştir"
	...
	arr["ENGLISH",456]="3.  Disable extended colorization permanently"
	arr["SPANISH",456]="3.  Deshabilitar permanentemente la colorización extendida"
	arr["FRENCH",456]="${pending_of_translation} 3.  Désactiver dé façon étendue permanante"
	arr["CATALAN",456]="${pending_of_translation} 3.  Deshabilita permanentment la coloració estesa"
	arr["PORTUGUESE",456]="${pending_of_translation} 3.  Desativar permanentemente a colorização estendida"
	arr["RUSSIAN",456]="${pending_of_translation} 3.  Постоянно отключать расширенную раскраску"
	arr["GREEK",456]="${pending_of_translation} 3.  Απενεργοποιήστε μόνιμα τον εκτεταμένο χρωματισμό"
	arr["ITALIAN",456]="${pending_of_translation} 3.  Disattivare permanentemente la colorazione estesa"
	arr["POLISH",456]="${pending_of_translation} 3.  Trwale wyłącz przedłużona kolorowanie"
	arr["GERMAN",456]="${pending_of_translation} 3.  Die erweiterte Einfärbung dauerhaft deaktivieren"
	arr["TURKISH",456]="${pending_of_translation} 3.  Genişletilmiş renklendirmeyi kalıcı olarak devre dışı bırak"
