...
function language_strings() {
	...
	arr["ENGLISH",447]="7.  Set permanently airgeddon's language to the current one"
	arr["SPANISH",447]="7.  Cambiar permanentemente el idioma de airgeddon al actual"
	arr["FRENCH",447]="7.  Etablir comme langue permanente d'airgeddon celle utilisée actuellement"
	arr["CATALAN",447]="7.  Canviar permanentment l'idioma de airgeddon a l'actual"
	arr["PORTUGUESE",447]="7.  Alterar permanentemente o idioma do airgeddon para o atual"
	arr["RUSSIAN",447]="7.  Сделать текущий язык airgeddon постоянным"
	arr["GREEK",447]="7.  Θέστε μόνιμα την τρέχουσα γλώσσα του airgeddon ως προεπιλεγμένη"
	arr["ITALIAN",447]="7.  Modificare in modo permanente la lingua di airgeddon a quella attuale"
	arr["POLISH",447]="7.  Trwale ustaw język airgeddon na aktualny"
	arr["GERMAN",447]="7.  Ändern Sie dauerhaft die Sprache von airgeddon zur aktuellen Sprache"
	arr["TURKISH",447]="7.  Sürekli olarak airgeddon'un dilini geçerli olana ayarla"
	...
	arr["ENGLISH",556]="3.  Enable colorization permanently"
	arr["SPANISH",556]="3.  Habilitar permanentemente la colorización"
	arr["FRENCH",556]="${pending_of_translation} 4.  Activer dé façon permanante la colorisation"
	arr["CATALAN",556]="${pending_of_translation} 4.  Habilita permanentment la coloració"
	arr["PORTUGUESE",556]="${pending_of_translation} 4.  Ativar permanentemente a colorização"
	arr["RUSSIAN",556]="${pending_of_translation} 4.  Включить раскраску навсегда"
	arr["GREEK",556]="${pending_of_translation} 4.  Ενεργοποιήστε τον χρωματισμό μόνιμα"
	arr["ITALIAN",556]="${pending_of_translation} 4.  Abilitare permanentemente la colorazione"
	arr["POLISH",556]="${pending_of_translation} 4.  Trwale włącz kolorowanie"
	arr["GERMAN",556]="${pending_of_translation} 4.  Die Einfärbung dauerhaft aktivieren"
	arr["TURKISH",556]="${pending_of_translation} 4.  Renklendirmeyi kalıcı olarak etkinleştir"

	arr["ENGLISH",557]="4.  Disable colorization permanently"
	arr["SPANISH",557]="4.  Deshabilitar permanentemente la colorización"
	arr["FRENCH",557]="${pending_of_translation} 4.  Désactiver dé façon permanante"
	arr["CATALAN",557]="${pending_of_translation} 4.  Deshabilita permanentment la coloració"
	arr["PORTUGUESE",557]="${pending_of_translation} 4.  Desativar permanentemente a colorização"
	arr["RUSSIAN",557]="${pending_of_translation} 4.  Постоянно отключать раскраску"
	arr["GREEK",557]="${pending_of_translation} 4.  Απενεργοποιήστε μόνιμα τον χρωματισμό"
	arr["ITALIAN",557]="${pending_of_translation} 4.  Disattivare permanentemente la colorazione"
	arr["POLISH",557]="${pending_of_translation} 4.  Trwale wyłącz kolorowanie"
	arr["GERMAN",557]="${pending_of_translation} 4.  Die Einfärbung dauerhaft deaktivieren"
	arr["TURKISH",557]="${pending_of_translation} 4.  Renklendirmeyi kalıcı olarak devre dışı bırak"

	arr["ENGLISH",558]="${blue_color}Colorization is going to be disabled. ${green_color}Do you want to continue? ${normal_color}${visual_choice}"
	arr["SPANISH",558]="${blue_color}Se va a desactivar la colorización. ${green_color}¿Deseas continuar? ${normal_color}${visual_choice}"
	arr["FRENCH",558]="${pending_of_translation} ${blue_color}Désactivation de la colorisation. ${green_color}Voulez-vous continuer? ${normal_color}${visual_choice}"
	arr["CATALAN",558]="${pending_of_translation} ${blue_color}Es va a desactivar le coloració. ${green_color}¿Vols continuar? ${normal_color}${visual_choice}"
	arr["PORTUGUESE",558]="${pending_of_translation} ${blue_color}A coloração será desabilitada. ${green_color}Você deseja continuar? ${normal_color}${visual_choice}"
	arr["RUSSIAN",558]="${pending_of_translation} ${blue_color}Раскраска будет включена. ${green_color}Вы хотите продолжить? ${normal_color}${visual_choice}"
	arr["GREEK",558]="${pending_of_translation} ${blue_color}Ο χρωματισμός θα ενεργοποιηθεί. ${green_color}Θέλετε να συνεχίσετε; ${normal_color}${visual_choice}"
	arr["ITALIAN",558]="${pending_of_translation} ${blue_color}La colorazione sará disattivata. ${green_color}Vuoi continuare? ${normal_color}${visual_choice}"
	arr["POLISH",558]="${pending_of_translation} ${blue_color}Koloryzacja zostanie wyłączona. ${green_color}Czy chcesz kontynuować? ${normal_color}${visual_choice}"
	arr["GERMAN",558]="${pending_of_translation} ${blue_color}Die Einfärbung wird deaktiviert. ${green_color}Möchten Sie fortfahren? ${normal_color}${visual_choice}"
	arr["TURKISH",558]="${pending_of_translation} ${blue_color}Renklendirme devre dışı bırakılacak. ${green_color}Devam etmek istiyor musunuz? ${normal_color}${visual_choice}"

	arr["ENGLISH",559]="${blue_color}Colorization is going to be enabled. ${green_color}Do you want to continue? ${normal_color}${visual_choice}"
	arr["SPANISH",559]="${blue_color}Se va a activar la colorización. ${green_color}¿Deseas continuar? ${normal_color}${visual_choice}"
	arr["FRENCH",559]="${pending_of_translation} ${blue_color}Activation colorisation. ${green_color}Voulez-vous continuer? ${normal_color}${visual_choice}"
	arr["CATALAN",559]="${pending_of_translation} ${blue_color}Es va a activar la coloració. ${green_color}¿Vols continuar? ${normal_color}${visual_choice}"
	arr["PORTUGUESE",559]="${pending_of_translation} ${blue_color}A coloração será ativada. ${green_color}Você deseja continuar? ${normal_color}${visual_choice}"
	arr["RUSSIAN",559]="${pending_of_translation} ${blue_color}Раскраска будет включена. ${green_color}Вы хотите продолжить? ${normal_color}${visual_choice}"
	arr["GREEK",559]="${pending_of_translation} ${blue_color}Ο χρωματισμός θα ενεργοποιηθεί. ${green_color}Θέλετε να συνεχίσετε; ${normal_color}${visual_choice}"
	arr["ITALIAN",559]="${pending_of_translation} ${blue_color}La colorazione sará attivata. ${green_color}Vuoi continuare? ${normal_color}${visual_choice}"
	arr["POLISH",559]="${pending_of_translation} ${blue_color}Kzostanie włączona. ${green_color}Czy chcesz kontynuować? ${normal_color}${visual_choice}"
	arr["GERMAN",559]="${pending_of_translation} ${blue_color}Die Einfärbung wird aktiviert. ${green_color}Wollen Sie fortfahren? ${normal_color}${visual_choice}"
	arr["TURKISH",559]="${pending_of_translation} ${blue_color}Renklendirme etkinleştirilecektir. ${green_color}Devam etmek istiyor musunuz? ${normal_color}${visual_choice}"

	arr["ENGLISH",560]="Colorization has been disabled"
	arr["SPANISH",560]="Se ha desactivado la colorización"
	arr["FRENCH",560]="${pending_of_translation} Colorisation désactivée"
	arr["CATALAN",560]="${pending_of_translation} S'ha desactivat la coloració"
	arr["PORTUGUESE",560]="${pending_of_translation} A colorização foi desativa"
	arr["RUSSIAN",560]="${pending_of_translation} Раскраска отключена"
	arr["GREEK",560]="${pending_of_translation} Ο χρωματισμός έχει απενεργοποιηθεί"
	arr["ITALIAN",560]="${pending_of_translation} La colorazione è stata disabilitata"
	arr["POLISH",560]="${pending_of_translation} Koloryzacja została wyłączona"
	arr["GERMAN",560]="${pending_of_translation} Die Einfärbung wurde deaktiviert"
	arr["TURKISH",560]="${pending_of_translation} Renklendirme devre dışı bırakıldı"

	arr["ENGLISH",561]="Colorization has been enabled"
	arr["SPANISH",561]="Se ha activado la colorización"
	arr["FRENCH",561]="${pending_of_translation} Colorisation activée"
	arr["CATALAN",561]="${pending_of_translation} S'ha activat la coloració"
	arr["PORTUGUESE",561]="${pending_of_translation} A colorização foi ativa"
	arr["RUSSIAN",561]="${pending_of_translation} Раскраска включена"
	arr["GREEK",561]="${pending_of_translation} Έχει ενεργοποιηθεί ο χρωματισμός"
	arr["ITALIAN",561]="${pending_of_translation} La colorazione è stata abilitata"
	arr["POLISH",561]="${pending_of_translation} Koloryzacja została aktywowana"
	arr["GERMAN",561]="${pending_of_translation} Die Einfärbung wurde aktiviert"
	arr["TURKISH",561]="${pending_of_translation} Renklendirme etkinleştirildi"
