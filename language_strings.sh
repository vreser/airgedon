...
function language_strings() {
	...
	arr["ENGLISH",518]="${blue_color}Your wifi card supports the 5Ghz band but \"wash\" tool is not able to scan both bands at once, so you have to make a choice. ${green_color}Do you want to scan in the 5Ghz band? ${pink_color}(If you answer no (\"n\"), 2.4Ghz band will be scanned) ${normal_color}${visual_choice}"
	arr["SPANISH",518]="${blue_color}Tu tarjeta wifi soporta la banda de los 5Ghz pero la herramienta \"wash\" no es capaz de escanear ambas bandas a la vez, por lo que has de elegir. ${green_color}¿Deseas escanear en la banda de los 5Ghz? ${pink_color}(Si respondes que no (\"n\"), se escaneará la banda de 2.4Ghz) ${normal_color}${visual_choice}"
	...
	arr["CATALAN",518]="${pending_of_translation} ${blue_color}La teva targeta wifi suporta la banda dels 5Ghz però l'eina \"wash\" no és capaç d'escanejar les dues bandes alhora, pel que has de triar. ${green_color}¿Voleu escanejar a la banda dels 5Ghz? ${pink_color}(Si respons que no (\"n\"), es escanejarà la banda de 2.4Ghz) ${normal_color}${visual_choice}"
	arr["PORTUGUESE",518]="${pending_of_translation} ${blue_color}O seu cartão wifi suporta a banda 5Ghz, mas a ferramenta \"wash\" não é capaz de escanear ambas as bandas ao mesmo tempo, então você deve escolher. ${green_color}Deseja digitalizar a banda 5Ghz? ${pink_color}(Se você responder não (\"n\"), a banda 2.4Ghz será digitalizada) ${normal_color}${visual_choice}"
	arr["RUSSIAN",518]="${pending_of_translation} ${blue_color}Ваша карта wifi поддерживает диапазон 5Ghz, но инструмент \"wash\" не способен одновременно сканировать обе полосы, поэтому вам нужно выбрать. ${green_color}Вы хотите сканировать в группе 5Ghz? ${pink_color}(Если вы ответите no (\"n\"), будет проверена полоса 2.4Ghz) ${normal_color}${visual_choice}"
	arr["GREEK",518]="${pending_of_translation} ${blue_color}Η κάρτα wifi υποστηρίζει τη ζώνη 5Ghz, αλλά το εργαλείο \"wash\" δεν μπορεί να σαρώσει και τις δύο ζώνες ταυτόχρονα, γι 'αυτό πρέπει να επιλέξετε. ${green_color}Θέλετε να σαρώσετε στη ζώνη 5Ghz; ${pink_color}(Εάν απαντήσετε όχι (\"n\"), η ζώνη 2.4Ghz θα σαρωθεί) ${normal_color}${visual_choice}"
	arr["ITALIAN",518]="${pending_of_translation} ${blue_color}La tua scheda wifi supporta la banda 5Ghz ma lo strumento \"wash\" non è in grado di scansionare entrambe le bande contemporaneamente, quindi devi scegliere. ${green_color}Vuoi eseguire la scansione nella banda 5Ghz? ${pink_color}(Se rispondi no (\"n\"), la banda 2.4Ghz verrà scansionata) ${normal_color}${visual_choice}"
	arr["POLISH",518]="${pending_of_translation} ${blue_color}Twoja karta wifi obsługuje pasmo 5Ghz, ale narzędzie \"wash\" nie jest w stanie skanować obu pasm w tym samym czasie, więc musisz wybrać. ${green_color}Czy chcesz skanować w paśmie 5Ghz? ${pink_color}(Jeśli odpowiesz nie (\"n\"), zostanie zeskanowane pasmo 2.4Ghz) ${normal_color}${visual_choice}"
