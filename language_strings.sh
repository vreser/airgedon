...
function language_strings() {
	...
	arr["ENGLISH",447]="8.  Set permanently airgeddon's language to the current one"
	arr["SPANISH",447]="8.  Cambiar permanentemente el idioma de airgeddon al actual"
	arr["FRENCH",447]="8.  Etablir comme langue permanente d'airgeddon celle utilisée actuellement"
	arr["CATALAN",447]="8.  Canviar permanentment l'idioma de airgeddon a l'actual"
	arr["PORTUGUESE",447]="8.  Alterar permanentemente o idioma do airgeddon para o atual"
	arr["RUSSIAN",447]="8.  Сделать текущий язык airgeddon постоянным"
	arr["GREEK",447]="8.  Θέστε μόνιμα την τρέχουσα γλώσσα του airgeddon ως προεπιλεγμένη"
	arr["ITALIAN",447]="8.  Modificare in modo permanente la lingua di airgeddon a quella attuale"
	arr["POLISH",447]="8.  Trwale ustaw język airgeddon na aktualny"
	arr["GERMAN",447]="8.  Ändern Sie dauerhaft die Sprache von airgeddon zur aktuellen Sprache"
	arr["TURKISH",447]="8.  Sürekli olarak airgeddon'un dilini geçerli olana ayarla"
