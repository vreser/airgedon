...
function language_strings() {
	...
	enterprise_texts["FRENCH",3]="${pending_of_translation} Avec cette attaque, nous attendrons qu'un client nous fournisse un hachage ou son mot de passe pour le réseau wifi d'entreprise dans notre faux point d'accès. \"smooth\" mode, donc dès qu'un hash ou un mot de passe est capturé, l'attaque va s'arrêter. Vous pouvez également arrêter l'attaque en appuyant sur la touche [Enter] de l'écran principal"
	enterprise_texts["CATALAN",3]="${pending_of_translation} Amb aquest atac, esperarem que algun client ens d'un hash o la contrasenya de la xarxa wifi Enterprise en el nostre AP fals. Heu seleccionat el mode \"smooth\", de manera que tan aviat es capturi un hash o contrasenya, l'atac es pararà. També pots parar l'atac prement la tecla [Enter] a la pantalla principal"
	enterprise_texts["PORTUGUESE",3]="${pending_of_translation} Com esse ataque, vamos esperar que um cliente nos forneça um hash ou senha para a rede wifi da empresa em nosso AP falso. Modo \"smooth\", assim que um hash ou senha é capturado, o ataque irá parar. Você também pode parar o ataque pressionando a tecla [Enter] na tela principal"
	...
	enterprise_texts["GREEK",3]="${pending_of_translation} Με αυτήν την επίθεση, θα περιμένουμε έναν πελάτη να μας δώσει ένα hash ή τον κωδικό του για το δίκτυο Enterprise wifi στο fake AP μας. \"smooth\", έτσι ώστε μόλις καταγραφεί ένας hash ή ένας κωδικός πρόσβασης, η επίθεση θα σταματήσει. Μπορείτε επίσης να σταματήσετε την επίθεση πατώντας το πλήκτρο [Enter] στην κύρια οθόνη"
	enterprise_texts["ITALIAN",3]="${pending_of_translation} Con questo attacco, aspetteremo che un cliente ci dia un hash o la sua password per la rete wifi aziendale nel nostro AP falso. Modalità \"smooth\", quindi non appena viene catturato un hash o una password, l'attacco si interrompe. Puoi anche fermare l'attacco premendo il tasto [Enter] sulla schermata principale"
	...
	enterprise_texts["GERMAN",3]="${pending_of_translation} Mit diesem Angriff werden wir darauf warten, dass ein Kunde uns einen Hash oder sein Passwort für das Enterprise wifi-Netzwerk in unserem gefälschten AP gibt. \"smooth\" Modus, sobald ein Hash oder Passwort erfasst wurde, wird der Angriff beendet. Sie können den Angriff auch durch Drücken der [Enter]-Taste auf dem Hauptbildschirm stoppen"
	...
	enterprise_texts["FRENCH",4]="${pending_of_translation} Avec cette attaque, nous attendrons qu'un client nous fournisse un hachage ou son mot de passe pour le réseau wifi d'entreprise dans notre faux point d'accès. Vous avez sélectionné le mode \"noisy\", ainsi l'attaque ne s'arrêtera pas tant que vous n'appuyez pas sur la touche [Enter] de l'écran principal"
	enterprise_texts["CATALAN",4]="${pending_of_translation} Amb aquest atac, esperarem que algun client ens d'un hash o la contrasenya de la xarxa wifi Enterprise en el nostre AP fals. Heu seleccionat el mode \"noisy\", de manera que l'atac no pararà fins que premis la tecla [Enter] a la pantalla principal"
	enterprise_texts["PORTUGUESE",4]="${pending_of_translation} Com esse ataque, vamos esperar que um cliente nos forneça um hash ou senha para a rede wifi da empresa em nosso AP falso. Você selecionou o modo \"noisy\", então o ataque não irá parar até que você pressione a tecla [Enter] na tela principal"
	...
	enterprise_texts["GREEK",4]="${pending_of_translation} Με αυτήν την επίθεση, θα περιμένουμε έναν πελάτη να μας δώσει ένα hash ή τον κωδικό του για το δίκτυο Enterprise wifi στο fake AP μας. Έχετε επιλέξει τη λειτουργία \"noisy\", οπότε η επίθεση δεν θα σταματήσει μέχρι να πατήσετε το πλήκτρο [Enter] στην κύρια οθόνη"
	enterprise_texts["ITALIAN",4]="${pending_of_translation} Con questo attacco, aspetteremo che un cliente ci dia un hash o la sua password per la rete wifi aziendale nel nostro AP falso. Hai selezionato la modalità \"noisy\", quindi l'attacco non si fermerà finché non premi il tasto [Enter] sulla schermata principale"
	...
	enterprise_texts["GERMAN",4]="${pending_of_translation} Mit diesem Angriff werden wir darauf warten, dass ein Kunde uns einen Hash oder sein Passwort für das Enterprise Wi-Fi-Netzwerk in unserem gefälschten AP gibt. Sie haben den \"noisy\" Modus gewählt, so dass der Angriff nicht stoppt, bis Sie die [Enter]-Taste auf dem Hauptbildschirm drücken"
	...
	arr["FRENCH",57]="${pending_of_translation} 10. Menu d'attaque Entreprise"
	arr["CATALAN",57]="${pending_of_translation} 10. Menú d'atacs Enterprise"
	arr["PORTUGUESE",57]="${pending_of_translation} 10. Menu de ataques Enterprise"
	arr["RUSSIAN",57]="${pending_of_translation} 10. Меню Enterprise атак"
	arr["GREEK",57]="${pending_of_translation} 10. Επιλογές Enterprise μενού"
	arr["ITALIAN",57]="${pending_of_translation} 10. Menu di attacco Enterprise"
	arr["POLISH",57]="${pending_of_translation} 10. Menu ataków Enterprise"
	arr["GERMAN",57]="${pending_of_translation} 10. Enterprise-Angriffsmenü"
	...
	arr["FRENCH",84]="${pending_of_translation} Menu d'attaque Entreprise"
	arr["CATALAN",84]="${pending_of_translation} Menú d'atacs Enterprise"
	arr["PORTUGUESE",84]="${pending_of_translation} Menu de ataques Enterprise"
	arr["RUSSIAN",84]="${pending_of_translation} Меню Enterprise атак"
	arr["GREEK",84]="${pending_of_translation} Επιλογές Enterprise μενού"
	arr["ITALIAN",84]="${pending_of_translation} Menu di attacco Enterprise"
	arr["POLISH",84]="${pending_of_translation} Menu ataków Enterprise"
	arr["GERMAN",84]="${pending_of_translation} Enterprise-Angriffsmenü"
	...
	arr["FRENCH",117]="${pending_of_translation} mode smooth, déconnecter après la capture"
	arr["CATALAN",117]="${pending_of_translation} manera smooth, desconnectar després de capturar"
	arr["PORTUGUESE",117]="${pending_of_translation} modo smooth, desconecte após a captura"
	arr["RUSSIAN",117]="${pending_of_translation} smooth режим, отключить после захвата"
	arr["GREEK",117]="${pending_of_translation} ομαλή smooth, αποσυνδέστε τη συσκευή μετά τη λήψη"
	arr["ITALIAN",117]="${pending_of_translation} modalità smooth, disconnettersi dopo l'acquisizione"
	arr["POLISH",117]="${pending_of_translation} tryb smooth, odłącz po przechwyceniu"
	arr["GERMAN",117]="${pending_of_translation} smooth-Modus, trennen Sie nach dem Capturen"
	...
	arr["FRENCH",248]="${pending_of_translation} mode noisy, pas d'interruptions"
	arr["CATALAN",248]="${pending_of_translation} manera noisy, sense interrupcions"
	arr["PORTUGUESE",248]="${pending_of_translation} modo noisy, sem interrupções"
	arr["RUSSIAN",248]="${pending_of_translation} noisy режим, без перерывов"
	arr["GREEK",248]="${pending_of_translation} noisy λειτουργία, χωρίς διακοπές"
	arr["ITALIAN",248]="${pending_of_translation} modalità noisy, senza interruzioni"
	arr["POLISH",248]="${pending_of_translation} noisy tryb, bez przerw"
	arr["GERMAN",248]="${pending_of_translation} noisy-Modus, keine Unterbrechungen"
	...
	arr["FRENCH",260]="${pending_of_translation} 5.  Evil Twin Enterprise mode smooth"
	arr["CATALAN",260]="${pending_of_translation} 5.  Evil Twin Enterprise manera smooth"
	arr["PORTUGUESE",260]="${pending_of_translation} 5.  Modo smooth do Evil Twin Enterprise"
	...
	arr["FRENCH",307]="${pending_of_translation} 6.  Evil Twin Enterprise mode noisy"
	arr["CATALAN",307]="${pending_of_translation} 6.  Evil Twin Enterprise manera noisy"
	arr["PORTUGUESE",307]="${pending_of_translation} 6.  Modo noisy do Evil Twin Enterprise"
	...
	arr["ENGLISH",332]="Before launching an attack on an Enterprise network, bear in mind that \"noisy\" mode will cause legitimate clients stuck trying to authenticate over and over again on the fake network. This could raise suspicions and you could be easily discovered"
	...
	arr["FRENCH",332]="${pending_of_translation} Avant de lancer une attaque contre un réseau d'entreprise, gardez à l'esprit que le mode \"noisy\" empêchera les clients légitimes d'essayer de s'authentifier encore et encore contre le faux réseau. Cela pourrait susciter des soupçons et pourrait être facilement découvert"
	arr["CATALAN",332]="${pending_of_translation} Abans de llançar un atac contra una xarxa Enterprise, tingues en compte que la manera \"noisy\" deixarà als clients legítims atrapats intentant autenticar cop i un altre contra la xarxa falsa. Això podria aixecar sospites i podries ser descobert fàcilment"
	arr["PORTUGUESE",332]="${pending_of_translation} Antes de iniciar um ataque contra uma rede Enterprise, lembre-se de que o modo \"noisy\" impedirá que clientes legítimos tentem se autenticar repetidas vezes contra a rede falsa. Isso poderia levantar suspeitas e poderia ser facilmente descoberto"
	...
	arr["GREEK",332]="${pending_of_translation} Πριν ξεκινήσετε μια επίθεση σε ένα δίκτυο Enterprise, λάβετε υπόψη σας ότι η λειτουργία \"noisy\" θα προκαλέσει την παραμονή των νόμιμων πελατών, προσπαθώντας να επαληθεύσουν ξανά και ξανά το πλαστό δίκτυο. Αυτό θα μπορούσε να προκαλέσει υποψίες και θα μπορούσε εύκολα να ανακαλυφθεί"
	arr["ITALIAN",332]="${pending_of_translation} Prima di lanciare un attacco contro una rete aziendale, tieni presente che la modalità \"noisy\" impedisce ai client legittimi di provare a eseguire l'autenticazione ripetutamente contro la rete fasulla. Questo potrebbe sollevare sospetti e potrebbe essere facilmente scoperto"
	...
	arr["GERMAN",332]="${pending_of_translation} Beachten Sie vor dem Starten eines Angriffs auf ein Unternehmensnetzwerk, dass der \"noisy\" Modus legitime Clients daran hindert, sich immer wieder gegen das gefälschte Netzwerk zu authentifizieren. Dies könnte zu Misstrauen führen und könnte leicht entdeckt werden"
	...
	arr["FRENCH",445]="${pending_of_translation} Si ccze est installé et que vous avez des erreurs d'affichage et de clignotement avec certaines fenêtres, désactivez la colorisation étendue depuis le menu options et langues"
	arr["CATALAN",445]="${pending_of_translation} Si tens instal·lat ccze i experimentes errors de visualització o pampallugues en algunes finestres, desactiva la coloració estesa al menú d'opcions i idioma"
	arr["PORTUGUESE",445]="${pending_of_translation} Se você tiver ccze instalado e estiver com erros de exibição ou com algumas janelas piscando, desative a colorização estendida em opções de menu e idioma"
	...
	arr["GREEK",445]="${pending_of_translation} Εάν έχετε εγκαταστήσει ccze και αντιμετωπίζετε σφάλματα εμφάνισης ή δυσλειτουργίες σε ορισμένα παράθυρα, θα πρέπει να απενεργοποιήσετε τον εκτεταμένο χρωματισμό στο μενού επιλογών και γλώσσας"
	arr["ITALIAN",445]="${pending_of_translation} Se hai installato ccze e vedi errori o alcune finestre tremolanti, disattiva la colorazione estesa nel menú opzioni e lingua"
	...
	arr["GERMAN",445]="${pending_of_translation} Wenn Sie ccze installiert haben und in einigen Fenstern Anzeigefehler oder Flimmern auftreten, deaktivieren Sie die erweiterte Einfärbung im Optionen- und Sprachmenü"
	...
	arr["FRENCH",450]="${pending_of_translation} 5.  Activer dé façon permanante la colorisation étendue"
	arr["CATALAN",450]="${pending_of_translation} 5.  Habilita permanentment la coloració estesa"
	arr["PORTUGUESE",450]="${pending_of_translation} 5.  Ativar permanentemente a colorização estendida"
	...
	arr["FRENCH",453]="${pending_of_translation} Colorisation étendue: ${pink_color}Activée${normal_color}"
	arr["CATALAN",453]="${pending_of_translation} Coloració estesa: ${pink_color}Activade${normal_color}"
	arr["PORTUGUESE",453]="${pending_of_translation} Colorização estendida: ${pink_color}Ativa${normal_color}"
	arr["RUSSIAN",453]="${pending_of_translation} Расширенная раскраска: ${pink_color}Включено${normal_color}"
	arr["GREEK",453]="${pending_of_translation} Εκτεταμένο χρώμα: ${pink_color}Ενεργοποιημένο${normal_color}"
	arr["ITALIAN",453]="${pending_of_translation} Colorazione estesa: ${pink_color}Abilitata${normal_color}"
	arr["POLISH",453]="${pending_of_translation} Przedłużona kolorowanie: ${pink_color}Włączone${normal_color}"
	arr["GERMAN",453]="${pending_of_translation} Erweiterte Einfärbung: ${pink_color}Aktiviert${normal_color}"
	...
	arr["FRENCH",454]="${pending_of_translation} Colorisation étendue: ${pink_color}Désactivée${normal_color}"
	arr["CATALAN",454]="${pending_of_translation} Coloració estesa: ${pink_color}Desactivade${normal_color}"
	arr["PORTUGUESE",454]="${pending_of_translation} Colorização estendida: ${pink_color}Desativa${normal_color}"
	arr["RUSSIAN",454]="${pending_of_translation} Расширенная раскраска: ${pink_color}Отключено${normal_color}"
	arr["GREEK",454]="${pending_of_translation} Εκτεταμένο χρώμα: ${pink_color}Απενεργοποιημένο${normal_color}"
	arr["ITALIAN",454]="${pending_of_translation} Colorazione estesa: ${pink_color}Disabilitata${normal_color}"
	arr["POLISH",454]="${pending_of_translation} Przedłużona kolorowanie: ${pink_color}Wyłączone${normal_color}"
	arr["GERMAN",454]="${pending_of_translation} Erweiterte Einfärbung: ${pink_color}Deaktiviert${normal_color}"
	...
	arr["FRENCH",456]="${pending_of_translation} 5.  Désactiver dé façon étendue permanante"
	arr["CATALAN",456]="${pending_of_translation} 5.  Deshabilita permanentment la coloració estesa"
	arr["PORTUGUESE",456]="${pending_of_translation} 5.  Desativar permanentemente a colorização estendida"
	arr["RUSSIAN",456]="${pending_of_translation} 5.  Постоянно отключать расширенную раскраску"
	arr["GREEK",456]="${pending_of_translation} 5.  Απενεργοποιήστε μόνιμα τον εκτεταμένο χρωματισμό"
	arr["ITALIAN",456]="${pending_of_translation} 5.  Disattivare permanentemente la colorazione estesa"
	arr["POLISH",456]="${pending_of_translation} 5.  Trwale wyłącz przedłużona kolorowanie"
	arr["GERMAN",456]="${pending_of_translation} 5.  Die erweiterte Einfärbung dauerhaft deaktivieren"
	...
	arr["FRENCH",462]="${pending_of_translation} ${blue_color}Désactivation de la colorisation étendue. ${green_color}Voulez-vous continuer? ${normal_color}${visual_choice}"
	arr["CATALAN",462]="${pending_of_translation} ${blue_color}Es va a desactivar le coloració estesa. ${green_color}¿Vols continuar? ${normal_color}${visual_choice}"
	arr["PORTUGUESE",462]="${pending_of_translation} ${blue_color}A coloração estendida será desabilitada. ${green_color}Você deseja continuar? ${normal_color}${visual_choice}"
	...
	arr["GREEK",462]="${pending_of_translation} ${blue_color}Ο εκτεταμένος χρωματισμός θα ενεργοποιηθεί. ${green_color}Θέλετε να συνεχίσετε; ${normal_color}${visual_choice}"
	arr["ITALIAN",462]="${pending_of_translation} ${blue_color}La colorazione estesa sará disattivata. ${green_color}Vuoi continuare? ${normal_color}${visual_choice}"
	...
	arr["GERMAN",462]="${pending_of_translation} ${blue_color}Die erweiterte Einfärbung wird deaktiviert. ${green_color}Möchten Sie fortfahren? ${normal_color}${visual_choice}"
	...
	arr["FRENCH",463]="${pending_of_translation} ${blue_color}Activation colorisation étendue. ${green_color}Voulez-vous continuer? ${normal_color}${visual_choice}"
	arr["CATALAN",463]="${pending_of_translation} ${blue_color}Es va a activar la coloració estesa. ${green_color}¿Vols continuar? ${normal_color}${visual_choice}"
	arr["PORTUGUESE",463]="${pending_of_translation} ${blue_color}A coloração estendida será ativada. ${green_color}Você deseja continuar? ${normal_color}${visual_choice}"
	...
	arr["GREEK",463]="${pending_of_translation} ${blue_color}Ο εκτεταμένος χρωματισμός θα ενεργοποιηθεί. ${green_color}Θέλετε να συνεχίσετε; ${normal_color}${visual_choice}"
	arr["ITALIAN",463]="${pending_of_translation} ${blue_color}La colorazione estesa sará attivata. ${green_color}Vuoi continuare? ${normal_color}${visual_choice}"
	...
	arr["GERMAN",463]="${pending_of_translation} ${blue_color}Die erweiterte Einfärbung wird aktiviert. ${green_color}Wollen Sie fortfahren? ${normal_color}${visual_choice}"
	...
	arr["FRENCH",465]="${pending_of_translation} Colorisation étendue activée"
	arr["CATALAN",465]="${pending_of_translation} S'ha activat la coloració estesa"
	arr["PORTUGUESE",465]="${pending_of_translation} A colorização estendida foi ativa"
	arr["RUSSIAN",465]="${pending_of_translation} Расширенная раскраска включена"
	arr["GREEK",465]="${pending_of_translation} Έχει ενεργοποιηθεί ο εκτεταμένος χρωματισμός"
	arr["ITALIAN",465]="${pending_of_translation} La colorazione estesa è stata abilitata"
	arr["POLISH",465]="${pending_of_translation} Przedłużona koloryzacja została aktywowana"
	arr["GERMAN",465]="${pending_of_translation} Die erweiterte Einfärbung wurde aktiviert"
	...
	arr["FRENCH",466]="${pending_of_translation} Colorisation étendue désactivée"
	arr["CATALAN",466]="${pending_of_translation} S'ha desactivat la coloració estesa"
	arr["PORTUGUESE",466]="${pending_of_translation} A colorização estendida foi desativa"
	arr["RUSSIAN",466]="${pending_of_translation} Расширенная раскраска отключена"
	arr["GREEK",466]="${pending_of_translation} Ο εκτεταμένος χρωματισμός έχει απενεργοποιηθεί"
	arr["ITALIAN",466]="${pending_of_translation} La colorazione estesa è stata disabilitata"
	arr["POLISH",466]="${pending_of_translation} Przedłużona koloryzacja została wyłączona"
	arr["GERMAN",466]="${pending_of_translation} Die erweiterte Einfärbung wurde deaktiviert"
	...
	arr["ITALIAN",467]="6.  Abilitare permanentemente il rilevamento automatico della lingua all'inizio"
	...
	arr["FRENCH",483]="${pending_of_translation} L'attaque en mode \"smooth\" dès qu'elle aura capturé un justificatif d'identité sera démantelée pour permettre aux clients de se reconnecter au réseau légitime. Cela réduit les chances d'être découvert, faisant ainsi penser à une défaillance inutile du réseau sans fil pour certains utilisateurs"
	arr["CATALAN",483]="${pending_of_translation} L'atac en mode \"smooth\" tan aviat capturi unes credencials es desmantellarà per deixar que els clients tornin a connectar-se a la xarxa legítima. Això redueix les possibilitats de ser descobert fent que per a alguns usuaris pugui semblar una fallada puntual de la xarxa sense fil"
	arr["PORTUGUESE",483]="${pending_of_translation} O ataque no modo \"smooth\", assim que capturar uma credencial, será desmontado para permitir que os clientes se reconectem à rede legítima. Isso reduz as chances de ser descoberto, fazendo com que pareça uma falha inútil da rede sem fio para alguns usuários"
	...
	arr["GREEK",483]="${pending_of_translation} Η επίθεση σε κατάσταση \"smooth\" θα αποσυναρμολογηθεί μόλις ληφθεί μια πιστοποίηση για να επιτρέψει στους πελάτες να επανασυνδεθούν ξανά στο νόμιμο δίκτυο. Αυτό μειώνει την πιθανότητα να ανακαλυφθεί, αναζητώντας ορισμένους χρήστες ως μια εσφαλμένη λειτουργία ασύρματου δικτύου"
	arr["ITALIAN",483]="${pending_of_translation} L'attacco in modalità \"smooth\" non appena acquisisce una credenziale verrà smantellato per consentire ai client di riconnettersi alla rete legittima. Questo riduce le possibilità di essere scoperti, facendolo sembrare un inutile fallimento della rete wireless per alcuni utenti"
	...
	arr["GERMAN",483]="${pending_of_translation} Der Angriff im Modus \"smooth\", sobald er einen Berechtigungsnachweis erfasst, wird abgebaut, damit die Clients sich wieder mit dem legitimen Netzwerk verbinden können. Dies verringert die Wahrscheinlichkeit, entdeckt zu werden, was für einige Benutzer als sinnloser Ausfall des drahtlosen Netzwerks erscheint."
	...
	arr["ENGLISH",514]="Interface ${pink_color}${current_iface_on_messages}${blue_color} selected. Mode: ${pink_color}${ifacemode}${blue_color}. Supported bands: ${pink_color}${interfaces_band_info['main_interface','text']}${normal_color}"
	arr["SPANISH",514]="Interfaz ${pink_color}${current_iface_on_messages}${blue_color} seleccionada. Modo: ${pink_color}${ifacemode}${blue_color}. Bandas soportadas: ${pink_color}${interfaces_band_info['main_interface','text']}${normal_color}"
	arr["FRENCH",514]="L'interface ${pink_color}${current_iface_on_messages}${blue_color} sélectionnée. Mode: ${pink_color}${ifacemode}${blue_color}. Bandes supportées: ${pink_color}${interfaces_band_info['main_interface','text']}${normal_color}"
	arr["CATALAN",514]="Interfície ${pink_color}${current_iface_on_messages}${blue_color} seleccionada. Mode: ${pink_color}${ifacemode}${blue_color}. Bandes suportades: ${pink_color}${interfaces_band_info['main_interface','text']}${normal_color}"
	arr["PORTUGUESE",514]="Interface ${pink_color}${current_iface_on_messages}${blue_color} selecionada. Modo: ${pink_color}${ifacemode}${blue_color}. Banda(s) suportada(s): ${pink_color}${interfaces_band_info['main_interface','text']}${normal_color}"
	arr["RUSSIAN",514]="Выбран интерфейс ${pink_color}${current_iface_on_messages}${blue_color}. Режим: ${pink_color}${ifacemode}${blue_color}. Поддерживаемые диапазоны: ${pink_color}${interfaces_band_info['main_interface','text']}${normal_color}"
	arr["GREEK",514]="Η διεπαφή ${pink_color}${current_iface_on_messages}${blue_color} έχει επιλεχθεί. Κατάσταση: ${pink_color}${ifacemode}${blue_color}. Υποστηριζόμενες ζώνες: ${pink_color}${interfaces_band_info['main_interface','text']}${normal_color}"
	arr["ITALIAN",514]="Interfaccia ${pink_color}${current_iface_on_messages}${blue_color} selezionata. Modalità: ${pink_color}${ifacemode}${blue_color}. Bande supportate: ${pink_color}${interfaces_band_info['main_interface','text']}${normal_color}"
	arr["POLISH",514]="Wybrany został interfejs ${pink_color}${current_iface_on_messages}${blue_color}. Tryb: ${pink_color}${ifacemode}${blue_color}. Obsługiwane pasma: ${pink_color}${interfaces_band_info['main_interface','text']}${normal_color}"
	arr["GERMAN",514]="Interface ${pink_color}${current_iface_on_messages}${blue_color} ausgewählt. Modus: ${pink_color}${ifacemode}${blue_color}. Unterstützte Bänder: ${pink_color}${interfaces_band_info['main_interface','text']}${normal_color}"
	arr["TURKISH",514]="${pending_of_translation} Arayüz ${pink_color}${current_iface_on_messages}${blue_color}seçildi. Kip: ${pink_color}${ifacemode}${blue_color}. Desteklenen bantlar: ${pink_color}${interfaces_band_info['main_interface','text']}${normal_color}"
	...
	arr["FRENCH",522]="${pending_of_translation} Evil Twin Enterprise mode smooth"
	arr["CATALAN",522]="${pending_of_translation} Evil Twin Enterprise manera smooth"
	arr["PORTUGUESE",522]="${pending_of_translation} Modo smooth do Evil Twin Enterprise"
	arr["RUSSIAN",522]="${pending_of_translation} Smooth режим Enterprise Evil Twin"
	arr["GREEK",522]="${pending_of_translation} Smooth λειτουργία Enterprise Evil Twin"
	...
	arr["FRENCH",523]="${pending_of_translation} Evil Twin Enterprise mode noisy"
	arr["CATALAN",523]="${pending_of_translation} Evil Twin Enterprise manera noisy"
	arr["PORTUGUESE",523]="${pending_of_translation} Modo noisy do Evil Twin Enterprise"
	arr["RUSSIAN",523]="${pending_of_translation} Noisy λειτουργία Enterprise Evil Twin"
	arr["GREEK",523]="${pending_of_translation} Noisy λειτουργία Enterprise Evil Twin"
	...
	arr["FRENCH",525]="${pending_of_translation} Si vous parvenez à capturer un hachage ou un mot de passe lors de l'attaque de Evil Twin Enterprise, vous devez décider de l'emplacement de sauvegarde. ${green_color}Plusieurs fichiers seront sauvegardés, écrivez le chemin (le répertoire) où nous écrirons le/s fichier/s. Si le répertoire n'existe pas, airgeddon le générera. Appuyez sur [Enter] pour accepter l'itinéraire proposé par défaut ${normal_color}[${enterprise_potpath}]"
	arr["CATALAN",525]="${pending_of_translation} Si s'aconsegueix capturar algun hash o contrasenya durant l'atac Evil Twin Enterprise, cal decidir on guardar-lo. ${green_color}Es guardaran diversos fitxers, escriu la ruta (directori) on escriurem el/s fitxer/s. Si en directori no existeix, airgeddon el generarà. Prem [Enter] per acceptar la ruta proposada per defecte ${normal_color}[${enterprise_potpath}]"
	arr["PORTUGUESE",525]="${pending_of_translation} Se você conseguir capturar um hash ou senha durante o ataque do Evil Twin Enterprise, terá que decidir onde salvá-lo. $ {green_color} Vários arquivos serão salvos, escreva o caminho (o diretório) onde iremos escrever o/s arquivo/s. Se o diretório não existir, o airgeddon irá gerá-lo. Pressione [Enter] para aceitar a rota proposta padrão ${normal_color}[${enterprise_potpath}]"
	arr["RUSSIAN",525]="${pending_of_translation} Если во время атаки Evil Twin Enterprise получен хэш или пароль, вы должны решить, где его сохранить. ${green_color}Будет сохранено более одного файла, введите путь (каталог) для хранения файлов/с. Если каталог не существует, airgeddon создаст его. Нажмите [Enter], чтобы принять предложение по умолчанию ${normal_color}[${enterprise_potpath}]"
	arr["GREEK",525]="${pending_of_translation} Εάν κατά τη διάρκεια της επίθεσης Evil Twin Enterprise προκύψει ένας κατακερματισμός ή ένας κωδικός πρόσβασης, θα πρέπει να αποφασίσετε πού να το αποθηκεύσετε. ${green_color}Θα αποθηκευτούν περισσότερα από ένα αρχεία, πληκτρολογήστε τη διαδρομή (κατάλογος) για την αποθήκευση των αρχείων. Εάν ο κατάλογος δεν υπάρχει, το airgeddon θα το δημιουργήσει. Πατήστε [Enter] για να αποδεχθείτε την προεπιλεγμένη πρόταση ${normal_color}[${enterprise_potpath}]"
	arr["ITALIAN",525]="${pending_of_translation} Se riesci a catturare un hash o una password durante l'attacco Evil Twin Enterprise, devi decidere dove salvarlo. ${green_color}Diversi file verranno salvati, scrivere il percorso (la directory) in cui scriveremo i file. Se la directory non esiste, airgeddon la genererà. Premere [Enter] per accettare il percorso proposto predefinito ${normal_color}[${enterprise_potpath}]"
	...
	arr["GERMAN",525]="${pending_of_translation} Wenn Sie während des Angriffs von Evil Twin Enterprise einen Hash oder ein Passwort erfassen können, müssen Sie entscheiden, wo er gespeichert werden soll. ${green_color}Es werden mehrere Dateien gespeichert. Geben Sie den Pfad (das Verzeichnis) ein, in dem wir die Datei(en) schreiben werden. Wenn das Verzeichnis nicht vorhanden ist, wird es von airgeddon erstellt. Bestätigen Sie mit [Enter], um die standardmäßig vorgeschlagene Route zu akzeptieren ${normal_color}[${enterprise_potpath}]"
	...
	arr["FRENCH",526]="${pending_of_translation} Le répertoire n'existe pas ou vous n'avez pas de permission en écriture"
	arr["CATALAN",526]="${pending_of_translation} El directori no existeix o no tens permisos d'escriptura"
	arr["PORTUGUESE",526]="${pending_of_translation} O diretório não existe ou você não tem permissão de escrita"
	arr["RUSSIAN",526]="${pending_of_translation} Каталог не существует или у вас нет разрешения на запись"
	arr["GREEK",526]="${pending_of_translation} Ο κατάλογος δεν υπάρχει ή δεν έχετε άδεια εγγραφής"
	arr["ITALIAN",526]="${pending_of_translation} La directory non esiste o non hai i permessi di scrittura"
	arr["POLISH",526]="${pending_of_translation} Katalog nie istnieje lub nie masz uprawnień do pisania"
	arr["GERMAN",526]="${pending_of_translation} Verzeichnis existiert nicht oder Sie haben keine Schreibberechtigung"
	...
	arr["FRENCH",527]="${pending_of_translation} Filtre WPA/WPA2 et Enterprise activés. Pendant l'analyse, il n'est pas possible de filtrer les réseaux Enterprise. Le filtre sera appliqué dans l'écran de sélection du réseau où seuls les réseaux Enterprise seront affichés. Une fois démarré, appuyez sur [Ctrl+C] pour l'arrêter..."
	arr["CATALAN",527]="${pending_of_translation} Filtre WPA/WPA2 i Enterprise activat. Durant l'escaneig no és possible filtrar xarxes Enterprise, el filtre s'aplicarà a la pantalla de selecció de xarxa on només es mostraran xarxes Enterprise. Un cop començat, premeu [Ctrl+C] per aturar-lo..."
	arr["PORTUGUESE",527]="${pending_of_translation} Filtro WPA/WPA2 e Enterprise ativados. Durante a verificação, não é possível filtrar redes Enterprise, o filtro será aplicado na tela de seleção de rede, onde apenas as redes Enterprise serão exibidas. Uma vez iniciado, pressione [Ctrl+C] para pará-lo..."
	arr["RUSSIAN",527]="${pending_of_translation} WPA/WPA2 и фильтр Enterprise. Во время проверки фильтровать сети Enterprise невозможно, фильтр будет применяться в меню выбора сети, в котором будут показаны только сети Enterprise. При запуске нажмите [Ctrl+C], чтобы остановить..."
	arr["GREEK",527]="${pending_of_translation} Το φίλτρο WPA/WPA2 και Enterprise είναι ενεργοποιημένο. Δεν είναι δυνατό να φιλτράρετε τα Enterprise δίκτυα κατά τη διάρκεια της σάρωσης, το φίλτρο θα εφαρμοστεί στο μενού επιλογής δικτύου στο οποίο θα εμφανίζονται μόνο τα Enterprise δίκτυα. Όταν ξεκινήσετε, πατήστε [Ctrl+C] για να σταματήσετε..."
	arr["ITALIAN",527]="${pending_of_translation} Filtro WPA/WPA2 e Enterprise attivati. Durante la scansione non è possibile filtrare le reti Enterprise, il filtro verrà applicato nella schermata di selezione della rete in cui verranno visualizzate solo le reti Enterprise. Una volta avviato, premi [Ctrl+C] per fermarlo..."
	...
	arr["GERMAN",527]="${pending_of_translation} WPA/WPA2- und Enterprise Filter aktiviert. Es ist nicht möglich, Enterprise-Netzwerke während des Scans zu filtern. Der Filter wird im Netzwerkauswahlmenü angewendet, in dem nur Enterprise-Netzwerke angezeigt werden. Beim Start drücken Sie [Ctrl+C], um zu stoppen..."
	...
	arr["FRENCH",538]="${pending_of_translation} Nous allons essayer de déchiffrer avec l'outil asleap le mot de passe de l'utilisateur ${normal_color}${enterprise_username}${blue_color} dont le défi et la réponse sont les suivants: ${normal_color}${enterprise_captured_challenges_responses[${enterprise_username}]}"
	arr["CATALAN",538]="${pending_of_translation} Es procedirà a intentar desxifrar amb l'eina asleap la contrasenya de l'usuari ${normal_color}${enterprise_username}${blue_color} el challenge i response són: ${normal_color}${enterprise_captured_challenges_responses[${enterprise_username}]}"
	arr["PORTUGUESE",538]="${pending_of_translation} Vamos tentar decifrar com a ferramenta asleap a senha do usuário ${normal_color}${enterprise_username}${blue_color} cujo desafio e resposta são: ${normal_color}${enterprise_captured_challenges_responses[${enterprise_username}]}"
	arr["RUSSIAN",538]="${pending_of_translation} Пароль для имени пользователя ${normal_color}${enterprise_username}${blue_color} будет подвергнут расшифровке с помощью asleap с использованием запроса и ответа: ${normal_color}${enterprise_captured_challenges_responses[${enterprise_username}]}"
	arr["GREEK",538]="${pending_of_translation} Ο κωδικός πρόσβασης για το όνομα χρήστη ${normal_color}${enterprise_username}${blue_color} θα δοκιμαστεί για να αποκρυπτογραφηθεί με το asleap χρησιμοποιώντας πρόκληση και απάντηση: ${normal_color}${enterprise_captured_challenges_responses[${enterprise_username}]}"
	arr["ITALIAN",538]="${pending_of_translation} Cercheremo di decifrare con lo strumento asleap la password dell'utente ${normal_color}${enterprise_username}${blue_color} la cui sfida e risposta sono: ${normal_color}${enterprise_captured_challenges_responses[${enterprise_username}]}"
	...
	arr["FRENCH",541]="${pending_of_translation} Voulez-vous réessayer en utilisant un autre dictionnaire avec asleap? ${normal_color}${visual_choice}"
	arr["CATALAN",541]="${pending_of_translation} Vols provar de nou l'atac amb asleap utilitzant un altre diccionari? ${normal_color}${visual_choice}"
	arr["PORTUGUESE",541]="${pending_of_translation} Você quer tentar o ataque de asleap novamente usando outro dicionário? ${normal_color}${visual_choice}"
	arr["RUSSIAN",541]="${pending_of_translation} Вы хотите повторить asleap атака с помощью другого словаря? ${normal_color}${visual_choice}"
	...
	arr["ITALIAN",541]="${pending_of_translation} Vuoi provare di nuovo l'attacco asleap usando un altro dizionario? ${normal_color}${visual_choice}"
	...
	arr["GERMAN",541]="${pending_of_translation} Möchten Sie Asleap Angriff mit einem anderen Wörterbuch wiederholen? ${normal_color}${visual_choice}"
	...
	arr["FRENCH",542]="${pending_of_translation} Vous venez de capturer le hash d'un utilisateur. Il a été sélectionné automatiquement"
	arr["CATALAN",542]="${pending_of_translation} Només vas capturar hash d'un usuari. S'ha seleccionat automàticament"
	arr["PORTUGUESE",542]="${pending_of_translation} Você acabou de capturar o hash de um usuário. Foi selecionado automaticamente"
	arr["RUSSIAN",542]="${pending_of_translation} Вы захватили хэш только для одного пользователя. автоотобран"
	arr["GREEK",542]="${pending_of_translation} Συγκεντρώσατε το hash μόνο για έναν χρήστη. Αυτόματη επιλογή"
	arr["ITALIAN",542]="${pending_of_translation} Hai appena catturato l'hash di un utente. È stato selezionato automaticamente"
	arr["POLISH",542]="${pending_of_translation} Zrobiłeś hasz tylko dla jednego użytkownika. Autoselected"
	arr["GERMAN",542]="${pending_of_translation} Sie haben Hash nur für einen Benutzer erfasst. Automatisch ausgewählt"
	...
	arr["FRENCH",543]="${pending_of_translation} L'option choisie n'est pas valide. Sélectionnez un numéro parmi ceux affichés dans le menu"
	arr["CATALAN",543]="${pending_of_translation} L'opció triada no és vàlida. Selecciona un nombre dels mostrats en el menú"
	arr["PORTUGUESE",543]="${pending_of_translation} A opção escolhida não é válida. Selecione um número entre os mostrados no menu"
	arr["RUSSIAN",543]="${pending_of_translation} Выбранная опция недействительна. Выберите один номер, показанный в меню"
	...
	arr["ITALIAN",543]="${pending_of_translation} L'opzione scelta non è valida. Seleziona un numero tra quelli indicati nel menu"
	arr["POLISH",543]="${pending_of_translation} Wybrana opcja jest nieprawidłowa. Wybierz jeden numer wyświetlony w menu"
	arr["GERMAN",543]="${pending_of_translation} Die gewählte Option ist ungültig. Wählen Sie eine Nummer aus dem Menü"
	...
	arr["ENGLISH",547]="3.  (john the ripper) Rule based attack against capture file"
	arr["SPANISH",547]="3.  (john the ripper) Ataque basado en reglas sobre fichero de captura"
	arr["FRENCH",547]="3.  (john the ripper) Attaque fondé sur des règles en utilisant le fichier de capture"
	arr["CATALAN",547]="3.  (john the ripper) Atac basat en regles sobre el fitxer de captura"
	arr["PORTUGUESE",547]="3.  (john the ripper) Ataque baseado em regras em um arquivo handshake"
	arr["RUSSIAN",547]="3.  (john the ripper) Атака на основе правила в отношении захваченного файла"
	arr["GREEK",547]="3.  (john the ripper) Επίθεση κανόνων σε αρχείο καταγραφής"
	arr["ITALIAN",547]="3.  (john the ripper) Attacco basato su regole contro il file di cattura"
	arr["POLISH",547]="3.  (john the ripper) Atak bazujący na regułach na plik przechwytywania"
	arr["GERMAN",547]="3.  (john the ripper) Regeln-basierender Angriff gegen der Capture-Datei"
	arr["TURKISH",547]="3.  (john the ripper) Yakalama dosyasına karşı kural tabanlı saldırı"
	...
	arr["ENGLISH",549]="7.  (asleap) Challenge/response dictionary attack"
	arr["SPANISH",549]="7.  (asleap) Ataque de diccionario challenge/response"
	arr["FRENCH",549]="${pending_of_translation} 7.  (asleap) Attaque du dictionnaire défi/réponse"
	arr["CATALAN",549]="${pending_of_translation} 7.  (asleap) Atac de diccionari challenge/response"
	arr["PORTUGUESE",549]="${pending_of_translation} 7.  (asleap) Ataque de desafio/resposta do dicionário"
	arr["RUSSIAN",549]="${pending_of_translation} 7.  (asleap) Атака словаря вызовом/ответом"
	arr["GREEK",549]="${pending_of_translation} 7.  (asleap) Επίθεση λεξικού πρόκλησης/απόκρισης"
	arr["ITALIAN",549]="${pending_of_translation} 7.  (asleap) Attacco di sfida/risposta del dizionario"
	arr["POLISH",549]="${pending_of_translation} 7.  (asleap) Atak słownikowego wyzwania/odpowiedzi"
	arr["GERMAN",549]="${pending_of_translation} 7.  (asleap) Angriff des Wörterbuchs Herausforderung/Antwort"
	arr["TURKISH",549]="${pending_of_translation} 7.  (asleap) Sözlük meydan okuması/yanıtı"

	arr["ENGLISH",550]="4.  (hashcat) Dictionary attack against capture file"
	arr["SPANISH",550]="4.  (hashcat) Ataque de diccionario sobre fichero de captura"
	arr["FRENCH",550]="4.  (hashcat) Attaque de dictionnaire en utilisant le fichier de capture"
	arr["CATALAN",550]="4.  (hashcat) Atac de diccionari sobre fitxer de captura"
	arr["PORTUGUESE",550]="4.  (hashcat) Ataque com dicionário em um handshake"
	arr["RUSSIAN",550]="4.  (hashcat) Атака по словарю в отношению захваченного файла"
	arr["GREEK",550]="4.  (hashcat) Επίθεση με χρήση λεξικού σε αρχείο καταγραφής"
	arr["ITALIAN",550]="4.  (hashcat) Attacco di dizionario sul file di cattura"
	arr["POLISH",550]="4.  (hashcat) Atak słownikowy na plik przechwytywania"
	arr["GERMAN",550]="4.  (hashcat) Wörterbuchangriff auf die Aufnahmedatei"
	arr["TURKISH",550]="4.  (hashcat) Yakalama dosyasına karşı sözlük saldırısı"

	arr["ENGLISH",551]="5.  (hashcat) Bruteforce attack against capture file"
	arr["SPANISH",551]="5.  (hashcat) Ataque de fuerza bruta sobre fichero de captura"
	arr["FRENCH",551]="5.  (hashcat) Attaque de force brute en utilisant le fichier de capture"
	arr["CATALAN",551]="5.  (hashcat) Atac de força bruta sobre fitxer de captura"
	arr["PORTUGUESE",551]="5.  (hashcat) Ataque de força bruta em um handshake"
	arr["RUSSIAN",551]="5.  (hashcat) Атака рукопожатия полным перебором"
	arr["GREEK",551]="5.  (hashcat) Επίθεση ωμής βίας σε αρχείο καταγραφής"
	arr["ITALIAN",551]="5.  (hashcat) Attacco di forza bruta sul file di cattura"
	arr["POLISH",551]="5.  (hashcat) Atak brute force na plik przechwytywania"
	arr["GERMAN",551]="5.  (hashcat) Brute-Force-Angriff auf die Capture-Datei"
	arr["TURKISH",551]="5.  (hashcat) Yakalama dosyasına karşı bruteforce saldırısı"

	arr["ENGLISH",552]="6.  (hashcat) Rule based attack against capture file"
	arr["SPANISH",552]="6.  (hashcat) Ataque basado en reglas sobre fichero de captura"
	arr["FRENCH",552]="6.  (hashcat) Attaque fondé sur des règles en utilisant le fichier de capture"
	arr["CATALAN",552]="6.  (hashcat) Atac basat en regles sobre el fitxer de captura"
	arr["PORTUGUESE",552]="6.  (hashcat) Ataque baseado em regras em um arquivo handshake"
	arr["RUSSIAN",552]="6.  (hashcat) Атака на основе правила в отношении захваченного файла"
	arr["GREEK",552]="6.  (hashcat) Επίθεση κανόνων σε αρχείο καταγραφής"
	arr["ITALIAN",552]="6.  (hashcat) Attacco basato su regole contro il file di cattura"
	...
	arr["RUSSIAN",556]="${pending_of_translation} 4.  Включить базовую окраску навсегда"
	arr["GREEK",556]="${pending_of_translation} 4.  Ενεργοποιήστε τον βασικό χρωματισμό μόνιμα"
	arr["ITALIAN",556]="${pending_of_translation} 4.  Abilitare permanentemente la colorazione di base"
	arr["POLISH",556]="${pending_of_translation} 4.  Włącz na stałe podstawowe kolory"
	arr["GERMAN",556]="${pending_of_translation} 4.  Grundfärbung dauerhaft aktivieren"
	...
	arr["FRENCH",557]="${pending_of_translation} 4.  Désactiver la colorisation de base de façon permanente"
	arr["CATALAN",557]="${pending_of_translation} 4.  Deshabilita permanentment la coloració bàsica"
	arr["PORTUGUESE",557]="${pending_of_translation} 4.  Desativar permanentemente a colorização básica"
	arr["RUSSIAN",557]="${pending_of_translation} 4.  Отключить базовую окраску навсегда"
	arr["GREEK",557]="${pending_of_translation} 4.  Απενεργοποιήστε μόνιμα τον βασικό χρωματισμό"
	arr["ITALIAN",557]="${pending_of_translation} 4.  Disattivare permanentemente la colorazione di base"
	arr["POLISH",557]="${pending_of_translation} 4.  Wyłącz permanentnie podstawową kolorystykę"
	arr["GERMAN",557]="${pending_of_translation} 4.  Grundfärbung dauerhaft deaktivieren"
	...
	arr["FRENCH",558]="${pending_of_translation} ${blue_color}Désactivation de la colorisation de base. ${green_color}Voulez-vous continuer? ${normal_color}${visual_choice}"
	arr["CATALAN",558]="${pending_of_translation} ${blue_color}Es va a desactivar le coloració bàsica. ${green_color}¿Vols continuar? ${normal_color}${visual_choice}"
	arr["PORTUGUESE",558]="${pending_of_translation} ${blue_color}A coloração básica será desabilitada. ${green_color}Você deseja continuar? ${normal_color}${visual_choice}"
	arr["RUSSIAN",558]="${pending_of_translation} ${blue_color}Базовая раскраска будет отключена. ${green_color}Вы хотите продолжить? ${normal_color}${visual_choice}"
	...
	arr["ITALIAN",558]="${pending_of_translation} ${blue_color}La colorazione di base sará disattivata. ${green_color}Vuoi continuare? ${normal_color}${visual_choice}"
	...
	arr["GERMAN",558]="${pending_of_translation} ${blue_color}Die Grundfärbung wird deaktiviert. ${green_color}Möchten Sie fortfahren? ${normal_color}${visual_choice}"
	...
	arr["FRENCH",559]="${pending_of_translation} ${blue_color}La colorisation de base va être activée. ${green_color}Voulez-vous continuer? ${normal_color}${visual_choice}"
	arr["CATALAN",559]="${pending_of_translation} ${blue_color}Es va a activar la coloració bàsica. ${green_color}¿Vols continuar? ${normal_color}${visual_choice}"
	arr["PORTUGUESE",559]="${pending_of_translation} ${blue_color}A coloração básica será ativada. ${green_color}Você deseja continuar? ${normal_color}${visual_choice}"
	arr["RUSSIAN",559]="${pending_of_translation} ${blue_color}Базовая раскраска будет включена. ${green_color}Вы хотите продолжить? ${normal_color}${visual_choice}"
	...
	arr["ITALIAN",559]="${pending_of_translation} ${blue_color}La colorazione di base sará attivata. ${green_color}Vuoi continuare? ${normal_color}${visual_choice}"
	...
	arr["GERMAN",559]="${pending_of_translation} ${blue_color}Die Grundfärbung wird aktiviert. ${green_color}Wollen Sie fortfahren? ${normal_color}${visual_choice}"
	...
	arr["FRENCH",560]="${pending_of_translation} Colorisation de base désactivée"
	arr["CATALAN",560]="${pending_of_translation} S'ha desactivat la coloració bàsica"
	arr["PORTUGUESE",560]="${pending_of_translation} A colorização básica foi desativa"
	arr["RUSSIAN",560]="${pending_of_translation} Базовая раскраска отключена"
	arr["GREEK",560]="${pending_of_translation} Ο βασικός χρωματισμός έχει απενεργοποιηθεί"
	arr["ITALIAN",560]="${pending_of_translation} La colorazione di base è stata disabilitata"
	arr["POLISH",560]="${pending_of_translation} Podstawowa kolorystyka została wyłączona"
	arr["GERMAN",560]="${pending_of_translation} Grundfärbung wurde deaktiviert"
	...
	arr["FRENCH",561]="${pending_of_translation} Colorisation de base activée"
	arr["CATALAN",561]="${pending_of_translation} S'ha activat la coloració bàsica"
	arr["PORTUGUESE",561]="${pending_of_translation} A colorização básica foi ativa"
	arr["RUSSIAN",561]="${pending_of_translation} Базовая раскраска включена"
	arr["GREEK",561]="${pending_of_translation} Έχει ενεργοποιηθεί ο βασικός χρωματισμός"
	arr["ITALIAN",561]="${pending_of_translation} La colorazione di base è stata abilitata"
	arr["POLISH",561]="${pending_of_translation} Włączono podstawową kolorystykę"
	arr["GERMAN",561]="${pending_of_translation} Grundfärbung wurde aktiviert"
	...
	arr["FRENCH",562]="${pending_of_translation} Cette option ne prendra effet que si vous activez la colorisation de base"
	arr["CATALAN",562]="${pending_of_translation} Aquesta opció no tindrà efecte fins que no activar la colorización bàsica"
	arr["PORTUGUESE",562]="${pending_of_translation} Esta opção não terá efeito até que você ative a colorização básica"
	arr["RUSSIAN",562]="${pending_of_translation} Этот параметр не будет действовать, пока вы не включите базовую окраску"
	arr["GREEK",562]="${pending_of_translation} Αυτή η επιλογή δεν θα τεθεί σε ισχύ μέχρι να ενεργοποιήσετε τον βασικό χρωματισμό"
	arr["ITALIAN",562]="${pending_of_translation} Questa opzione non ha effetto finché non si attiva la colorazione di base"
	arr["POLISH",562]="${pending_of_translation} Ta opcja nie zacznie obowiązywać, dopóki nie włączysz podstawowego kolorowania"
	arr["GERMAN",562]="${pending_of_translation} Diese Option wird erst wirksam, wenn Sie die grundlegende Einfärbung aktivieren"
	...
	arr["FRENCH",563]="${pending_of_translation} Colorisation de base: ${pink_color}Activée${normal_color}"
	arr["CATALAN",563]="${pending_of_translation} Coloració bàsica: ${pink_color}Activade${normal_color}"
	arr["PORTUGUESE",563]="${pending_of_translation} Colorização básica: ${pink_color}Ativa${normal_color}"
	arr["RUSSIAN",563]="${pending_of_translation} Базовая раскраска: ${pink_color}Включено${normal_color}"
	arr["GREEK",563]="${pending_of_translation} Βασικός χρωματισμός: ${pink_color}Ενεργοποιημένο${normal_color}"
	arr["ITALIAN",563]="${pending_of_translation} Colorazione di base: ${pink_color}Abilitata${normal_color}"
	arr["POLISH",563]="${pending_of_translation} Podstawowe zabarwienie: ${pink_color}Włączone${normal_color}"
	arr["GERMAN",563]="${pending_of_translation} Grundfärbung: ${pink_color}Aktiviert${normal_color}"
	...
	arr["FRENCH",564]="${pending_of_translation} Colorisation de base: ${pink_color}Désactivée${normal_color}"
	arr["CATALAN",564]="${pending_of_translation} Coloració bàsica: ${pink_color}Desactivade${normal_color}"
	arr["PORTUGUESE",564]="${pending_of_translation} Colorização básica: ${pink_color}Desativa${normal_color}"
	arr["RUSSIAN",564]="${pending_of_translation} Базовая раскраска: ${pink_color}Отключено${normal_color}"
	arr["GREEK",564]="${pending_of_translation} Βασικός χρωματισμός: ${pink_color}Απενεργοποιημένο${normal_color}"
	arr["ITALIAN",564]="${pending_of_translation} Colorazione di base: ${pink_color}Disabilitata${normal_color}"
	arr["POLISH",564]="${pending_of_translation} Podstawowe zabarwienie: ${pink_color}Wyłączone${normal_color}"
	arr["GERMAN",564]="${pending_of_translation} Grundfärbung: ${pink_color}Deaktiviert${normal_color}"
	...
	arr["FRENCH",565]="${pending_of_translation} 3.  Désactiver en permanence pour ignorer l'intro"
	arr["CATALAN",565]="${pending_of_translation} 3.  Deshabilitar permanentment saltar-se la intro"
	arr["PORTUGUESE",565]="${pending_of_translation} 3.  Desativar permanentemente para pular a introdução"
	arr["RUSSIAN",565]="${pending_of_translation} 3.  Постоянно отключать, чтобы пропустить ввод"
	arr["GREEK",565]="${pending_of_translation} 3.  Απενεργοποιήστε μόνιμα για να παραλείψετε την εισαγωγή"
	arr["ITALIAN",565]="${pending_of_translation} 3.  Disattiva permanentemente per saltare l'introduzione"
	arr["POLISH",565]="${pending_of_translation} 3.  Trwale wyłącz, aby pominąć wprowadzenie"
	arr["GERMAN",565]="${pending_of_translation} 3.  Deaktivieren Sie dauerhaft, um das Intro zu überspringen"
	...
	arr["FRENCH",566]="${pending_of_translation} 3.  Activer en permanence pour ignorer l'intro"
	arr["CATALAN",566]="${pending_of_translation} 3.  Habilitar permanentment saltar-se la intro"
	arr["PORTUGUESE",566]="${pending_of_translation} 3.  Permitir permanentemente ignorar a introdução"
	arr["RUSSIAN",566]="${pending_of_translation} 3.  Постоянно разрешать пропустить ввод"
	arr["GREEK",566]="${pending_of_translation} 3.  Επιτρέψτε μόνιμα να παραλείψετε την εισαγωγή"
	arr["ITALIAN",566]="${pending_of_translation} 3.  Abilitare permanentemente per saltare l'introduzione"
	arr["POLISH",566]="${pending_of_translation} 3.  TTrwale włącz pomiń intro"
	arr["GERMAN",566]="${pending_of_translation} 3.  Aktivieren Sie das Intro dauerhaft"
	...
	arr["FRENCH",567]="${pending_of_translation} Passer l'intro: ${pink_color}Activée${normal_color}"
	arr["CATALAN",567]="${pending_of_translation} Omet la introducció: ${pink_color}Activat${normal_color}"
	arr["PORTUGUESE",567]="${pending_of_translation} Pular introdução: ${pink_color}Ativado${normal_color}"
	...
	arr["GERMAN",567]="${pending_of_translation} Intro überspringen: ${pink_color}Aktiviert${normal_color}"
	...
	arr["FRENCH",568]="${pending_of_translation} Passer l'intro: ${pink_color}Désactivé${normal_color}"
	arr["CATALAN",568]="${pending_of_translation} Omet la introducció: ${pink_color}Desactivat${normal_color}"
	arr["PORTUGUESE",568]="${pending_of_translation} Pular introdução: ${pink_color}Desativado${normal_color}"
	arr["RUSSIAN",568]="${pending_of_translation} Пропустить вступление: ${pink_color}Дезактивированный${normal_color}"
	arr["GREEK",568]="${pending_of_translation} Παράλειψη εισαγωγής: ${pink_color}Απενεργοποιημένο${normal_color}"
	arr["ITALIAN",568]="${pending_of_translation} Salta l'introduzione: ${pink_color}Disabilitato${normal_color}"
	arr["POLISH",568]="${pending_of_translation} Pomiń wstęp: ${pink_color}Dezaktywowane${normal_color}"
	arr["GERMAN",568]="${pending_of_translation} Intro überspringen: ${pink_color}Deaktiviert${normal_color}"
	...
	arr["FRENCH",569]="${pending_of_translation} ${blue_color}Ça va désactiver sauter l'intro. ${green_color}Voulez-vous continuer? ${normal_color}${visual_choice}"
	arr["CATALAN",569]="${pending_of_translation} ${blue_color}Es va a desactivar saltar-se la intro. ${green_color}¿Vols continuar? ${normal_color}${visual_choice}"
	arr["PORTUGUESE",569]="${pending_of_translation} ${blue_color}Vai desativar a ignorar a introdução. ${green_color}Você deseja continuar? ${normal_color}${visual_choice}"
	arr["RUSSIAN",569]="${pending_of_translation} ${blue_color}Он отключит пропустить ввод. ${green_color}Вы хотите продолжить? ${normal_color}${visual_choice}"
	...
	arr["ITALIAN",569]="${pending_of_translation} ${blue_color}Disabilita il salto dell'intro. ${green_color}Vuoi continuare? ${normal_color}${visual_choice}"
	...
	arr["GERMAN",569]="${pending_of_translation} ${blue_color}Es wird das Überspringen des Intro deaktivieren. ${green_color}Möchten Sie fortfahren? ${normal_color}${visual_choice}"
	...
	arr["FRENCH",570]="${pending_of_translation} ${blue_color}Il s'activera pour ignorer l'intro. ${green_color}Voulez-vous continuer? ${normal_color}${visual_choice}"
	arr["CATALAN",570]="${pending_of_translation} ${blue_color}Es va a activar saltar-se la intro. ${green_color}¿Vols continuar? ${normal_color}${visual_choice}"
	arr["PORTUGUESE",570]="${pending_of_translation} ${blue_color}Ele será ativado para pular a introdução. ${green_color}Você deseja continuar? ${normal_color}${visual_choice}"
	arr["RUSSIAN",570]="${pending_of_translation} ${blue_color}Он активируется, чтобы пропустить ввод. ${green_color}Вы хотите продолжить? ${normal_color}${visual_choice}"
	...
	arr["ITALIAN",570]="${pending_of_translation} ${blue_color}Si attiverà per saltare l'introduzione. ${green_color}Vuoi continuare? ${normal_color}${visual_choice}"
	...
	arr["GERMAN",570]="${pending_of_translation} ${blue_color}Es wird aktiviert, um das Intro zu überspringen. ${green_color} Möchten Sie fortfahren? ${normal_color}${visual_choice}"
	...
	arr["FRENCH",571]="${pending_of_translation} Passer l'intro a été désactivé"
	arr["CATALAN",571]="${pending_of_translation} S'ha desactivat la introducció de l'omet salt"
	arr["PORTUGUESE",571]="${pending_of_translation} A introdução de Skip foi desativada"
	arr["RUSSIAN",571]="${pending_of_translation} Перейти к началу страницы"
	arr["GREEK",571]="${pending_of_translation} Η παράλειψη εισαγωγής έχει απενεργοποιηθεί"
	arr["ITALIAN",571]="${pending_of_translation} Skip intro è stato disabilitato"
	arr["POLISH",571]="${pending_of_translation} Pominięcie intro zostało wyłączone"
	arr["GERMAN",571]="${pending_of_translation} Intro überspringen wurde deaktiviert"
	...
	arr["FRENCH",572]="${pending_of_translation} Passer l'intro a été activé"
	arr["CATALAN",572]="${pending_of_translation} S'ha activat la introducció de l'omet salt"
	arr["PORTUGUESE",572]="${pending_of_translation} A introdução de pulos foi ativada"
	arr["RUSSIAN",572]="${pending_of_translation} Включено пропустить ввод"
	arr["GREEK",572]="${pending_of_translation} Η παράλειψη εισαγωγής έχει ενεργοποιηθεί"
	arr["ITALIAN",572]="${pending_of_translation} Skip intro è stato abilitato"
	arr["POLISH",572]="${pending_of_translation} Pominięto wprowadzenie zostało włączone"
	arr["GERMAN",572]="${pending_of_translation} Intro überspringen wurde aktiviert"
	...
	arr["FRENCH",573]="${pending_of_translation} 7.  Désactiver en permanence contrôles silencieux"
	arr["CATALAN",573]="${pending_of_translation} 7.  Deshabilitar permanentment revisions silencioses"
	arr["PORTUGUESE",573]="${pending_of_translation} 7.  Desativar permanentemente os controles silenciosos"
	arr["RUSSIAN",573]="${pending_of_translation} 7.  Постоянно отключать тихие проверки"
	arr["GREEK",573]="${pending_of_translation} 7.  Απενεργοποιείτε μόνιμα τους σιωπηρούς ελέγχους"
	arr["ITALIAN",573]="${pending_of_translation} 7.  Disattiva permanentemente i controlli silenziosi"
	arr["POLISH",573]="${pending_of_translation} 7.  Trwale wyłączyć ciche kontrole"
	arr["GERMAN",573]="${pending_of_translation} 7.  Deaktivieren Sie die stillen Überprüfungen dauerhaft"
	...
	arr["FRENCH",574]="${pending_of_translation} 7.  Activer en permanence contrôles silencieux"
	arr["CATALAN",574]="${pending_of_translation} 7.  Habilitar permanentment revisions silencioses"
	arr["PORTUGUESE",574]="${pending_of_translation} 7.  Permitir permanentemente os controles silenciosos"
	arr["RUSSIAN",574]="${pending_of_translation} 7.  Постоянно включать бесшумные проверки"
	arr["GREEK",574]="${pending_of_translation} 7.  Ενεργοποιήστε μόνιμα τους σιωπηρούς ελέγχους"
	arr["ITALIAN",574]="${pending_of_translation} 7.  Abilitare permanentemente i controlli silenziosi"
	arr["POLISH",574]="${pending_of_translation} 7.  Trwale włącz ciche kontrole"
	arr["GERMAN",574]="${pending_of_translation} 7.  Stille Prüfungen dauerhaft aktivieren"
	...
	arr["FRENCH",575]="${pending_of_translation} Contrôles silencieux: ${pink_color}Activée${normal_color}"
	arr["CATALAN",575]="${pending_of_translation} Xecs silenciosos: ${pink_color}Activades${normal_color}"
	arr["PORTUGUESE",575]="${pending_of_translation} Inspeções silenciosas: ${pink_color}Ativadas${normal_color}"
	arr["RUSSIAN",575]="${pending_of_translation} Тихие проверки: ${pink_color}Включено${normal_color}"
	arr["GREEK",575]="${pending_of_translation} Σιωπηλοί έλεγχοι: ${pink_color}Ενεργοποιημένο${normal_color}"
	arr["ITALIAN",575]="${pending_of_translation} Assegni silenziosi: ${pink_color}Abilitati${normal_color}"
	arr["POLISH",575]="${pending_of_translation} Ciche kontrole: ${pink_color}Aktywowane${normal_color}"
	arr["GERMAN",575]="${pending_of_translation} Lautlose Kontrollen: ${pink_color}Aktiviert${normal_color}"
	...
	arr["FRENCH",576]="${pending_of_translation} Contrôles silencieux: ${pink_color}Désactivée${normal_color}"
	arr["CATALAN",576]="${pending_of_translation} Xecs silenciosos: ${pink_color}Desactivades${normal_color}"
	arr["PORTUGUESE",576]="${pending_of_translation} Inspeções silenciosas: ${pink_color}Desativadas${normal_color}"
	arr["RUSSIAN",576]="${pending_of_translation} Тихие проверки: ${pink_color}Отключено${normal_color}"
	arr["GREEK",576]="${pending_of_translation} Σιωπηλοί έλεγχοι: ${pink_color}Απενεργοποιημένο${normal_color}"
	arr["ITALIAN",576]="${pending_of_translation} Assegni silenziosi: ${pink_color}Disabilitati${normal_color}"
	arr["POLISH",576]="${pending_of_translation} Ciche kontrole: ${pink_color}Niepełnosprawnych${normal_color}"
	arr["GERMAN",576]="${pending_of_translation} Lautlose Kontrollen: ${pink_color}Deaktiviert${normal_color}"
	...
	arr["FRENCH",577]="${pending_of_translation} ${blue_color}Les contrôles silencieux seront désactivés. ${green_color}Voulez-vous continuer? ${normal_color}${visual_choice}"
	arr["CATALAN",577]="${pending_of_translation} ${blue_color}Es van a desactivar les xecs silencioses. ${green_color}¿Vols continuar? ${normal_color}${visual_choice}"
	arr["PORTUGUESE",577]="${pending_of_translation} ${blue_color}Inspeções silenciosas serão desativadas. ${green_color}Você deseja continuar? ${normal_color}${visual_choice}"
	arr["RUSSIAN",577]="${pending_of_translation} ${blue_color}Молчаливые проверки будут отключены. ${green_color}Вы хотите продолжить? ${normal_color}${visual_choice}"
	...
	arr["ITALIAN",577]="${pending_of_translation} ${blue_color}I controlli silenziosi saranno disabilitati ${green_color}Vuoi continuare? ${normal_color}${visual_choice}"
	...
	arr["GERMAN",577]="${pending_of_translation} ${blue_color}Lautlose Prüfungen werden deaktiviert. ${green_color}Wollen Sie weitermachen? ${normal_color}${visual_choice}"
	...
	arr["FRENCH",578]="${pending_of_translation} ${blue_color}Les contrôles silencieux vont être activés. ${green_color}Voulez-vous continuer? ${normal_color}${visual_choice}"
	arr["CATALAN",578]="${pending_of_translation} ${blue_color}Es van a habilitar les xecs silencioses. ${green_color}¿Vols continuar? ${normal_color}${visual_choice}"
	arr["PORTUGUESE",578]="${pending_of_translation} ${blue_color}Inspeções silenciosas serão ativadas. ${green_color}Você deseja continuar? ${normal_color}${visual_choice}"
	arr["RUSSIAN",578]="${pending_of_translation} ${blue_color}Молчаливые проверки будут включены. ${green_color}Вы хотите продолжить? ${normal_color}${visual_choice}"
	...
	arr["ITALIAN",578]="${pending_of_translation} ${blue_color}I controlli silenziosi saranno abilitati ${green_color}Vuoi continuare? ${normal_color}${visual_choice}"
	...
	arr["GERMAN",578]="${pending_of_translation} ${blue_color}Lautlose Prüfungen werden aktiviert. ${green_color}Wollen Sie weitermachen? ${normal_color}${visual_choice}"
	...
	arr["FRENCH",579]="${pending_of_translation} Les contrôles silencieux ont été désactivés"
	arr["CATALAN",579]="${pending_of_translation} S'han desactivat les xecs silencioses"
	arr["PORTUGUESE",579]="${pending_of_translation} Inspeções silenciosas foram desativadas"
	arr["RUSSIAN",579]="${pending_of_translation} Молчаливые проверки отключены"
	arr["GREEK",579]="${pending_of_translation} Οι αθόρυβοι έλεγχοι έχουν απενεργοποιηθεί"
	arr["ITALIAN",579]="${pending_of_translation} I controlli silenziosi sono stati disattivati"
	arr["POLISH",579]="${pending_of_translation} Ciche kontrole zostały dezaktywowane"
	arr["GERMAN",579]="${pending_of_translation} Lautlose Prüfungen wurden deaktiviert"
	...
	arr["FRENCH",580]="${pending_of_translation} Les contrôles silencieux ont été activés"
	arr["CATALAN",580]="${pending_of_translation} S'han activat les xecs silenciosos"
	arr["PORTUGUESE",580]="${pending_of_translation} Inspeções silenciosas foram ativadas"
	arr["RUSSIAN",580]="${pending_of_translation} Модифицированные проверки активированы"
	arr["GREEK",580]="${pending_of_translation} Έχουν ενεργοποιηθεί οι σιωπηλοί έλεγχοι"
	arr["ITALIAN",580]="${pending_of_translation} Sono stati attivati i controlli silenziosi"
	arr["POLISH",580]="${pending_of_translation} Nieaktywne kontrole zostały aktywowane"
	arr["GERMAN",580]="${pending_of_translation} Lautlose Prüfungen wurden aktiviert"
	...
	arr["FRENCH",581]="${pending_of_translation} Vous avez lancé airgeddon avec les contrôles silencieux activés. Désactiver cette option pour voir quel est le problème"
	arr["CATALAN",581]="${pending_of_translation} Vas llançar airgeddon amb les xecs silencioses activats. Deshabilita aquesta opció per veure com és el problema"
	arr["PORTUGUESE",581]="${pending_of_translation} Você lançou o airgeddon com as inspeções silenciosas ativadas. Desative essa opção para ver qual é o problema"
	arr["RUSSIAN",581]="${pending_of_translation} Вы запустили airgeddon с включенными тихими проверками. Отключите этот параметр, чтобы узнать, в чем проблема."
	...
	arr["ITALIAN",581]="${pending_of_translation} Hai lanciato airgeddon con i controlli silenziosi attivati. Disabilita questa opzione per vedere qual è il problema"
	...
	arr["GERMAN",581]="${pending_of_translation} Sie haben airgeddon mit aktivierten Silent-Checks gestartet. Deaktivieren Sie diese Option, um das Problem zu sehen"
	...
	arr["FRENCH",582]="${pending_of_translation} Montrer Conseils: ${pink_color}Activée${normal_color}"
	arr["CATALAN",582]="${pending_of_translation} Mostra consells: ${pink_color}Activat${normal_color}"
	arr["PORTUGUESE",582]="${pending_of_translation} Mostrar conselhos: ${pink_color}Ativado${normal_color}"
	arr["RUSSIAN",582]="${pending_of_translation} Показать подсказки: ${pink_color}Активированный${normal_color}"
	arr["GREEK",582]="${pending_of_translation} Εμφάνιση συμβουλών: ${pink_color}Ενεργοποιήθηκε${normal_color}"
	arr["ITALIAN",582]="${pending_of_translation} Mostra Consigli: ${pink_color}Habilitato${normal_color}"
	arr["POLISH",582]="${pending_of_translation} Pokaż wskazówki: ${pink_color}Aktywowany${normal_color}"
	arr["GERMAN",582]="${pending_of_translation} Tipps anzeigen: ${pink_color}Aktiviert${normal_color}"
	...
	arr["FRENCH",583]="${pending_of_translation} Montrer Conseils: ${pink_color}Désactivé${normal_color}"
	arr["CATALAN",583]="${pending_of_translation} Mostra consells: ${pink_color}Desactivat${normal_color}"
	arr["PORTUGUESE",583]="${pending_of_translation} Mostrar conselhos: ${pink_color}Desativado${normal_color}"
	arr["RUSSIAN",583]="${pending_of_translation} Показать подсказки: ${pink_color}Дезактивированный${normal_color}"
	arr["GREEK",583]="${pending_of_translation} Εμφάνιση συμβουλών: ${pink_color}Απενεργοποιημένο${normal_color}"
	arr["ITALIAN",583]="${pending_of_translation} Mostra Consigli: ${pink_color}Disabilitato${normal_color}"
	arr["POLISH",583]="${pending_of_translation} Pokaż wskazówki: ${pink_color}Dezaktywowane${normal_color}"
	arr["GERMAN",583]="${pending_of_translation} Tipps anzeigen: ${pink_color}Deaktiviert${normal_color}"
	...
	arr["FRENCH",584]="${pending_of_translation} 8.  Désactiver les conseils sur les émissions de manière permanente"
	arr["CATALAN",584]="${pending_of_translation} 8.  Deshabilitar mostrar consells permanentment"
	arr["PORTUGUESE",584]="${pending_of_translation} 8.  Desativar permanentemente os dicas conselhos"
	arr["RUSSIAN",584]="${pending_of_translation} 8.  Отключить показ советов"
	arr["GREEK",584]="${pending_of_translation} 8.  Απενεργοποιήστε τις συμβουλές εμφάνισης μόνιμα"
	arr["ITALIAN",584]="${pending_of_translation} 8.  Disattiva permanentemente i suggerimenti per lo show"
	arr["POLISH",584]="${pending_of_translation} 8.  Wyłącz trwale wskazówki show"
	arr["GERMAN",584]="${pending_of_translation} 8.  Showtipps dauerhaft deaktivieren"
	...
	arr["FRENCH",585]="${pending_of_translation} 8.  Activer pour afficher des conseils en permanence"
	arr["CATALAN",585]="${pending_of_translation} 8.  Habilitar mostrar consells permanentment"
	arr["PORTUGUESE",585]="${pending_of_translation} 8.  Ativar para mostrar conselhos permanentemente"
	arr["RUSSIAN",585]="${pending_of_translation} 8.  Позволять постоянно показывать советы"
	arr["GREEK",585]="${pending_of_translation} 8.  Ενεργοποιήστε τη μόνιμη παροχή συμβουλών"
	arr["ITALIAN",585]="${pending_of_translation} 8.  Abilitare per mostrare un consiglio in modo permanente"
	arr["POLISH",585]="${pending_of_translation} 8.  Włącz, aby wyświetlać porady na stałe"
	arr["GERMAN",585]="${pending_of_translation} 8.  Aktivieren Sie diese Option, um den Rat permanent anzuzeigen"
	...
	arr["FRENCH",586]="${pending_of_translation} ${blue_color}Cela désactivera les conseils sur le spectacle. ${green_color}Voulez-vous continuer? ${normal_color}${visual_choice}"
	arr["CATALAN",586]="${pending_of_translation} ${blue_color}Es va a desactivar mostrar consells. ${green_color}¿Vols continuar? ${normal_color}${visual_choice}"
	arr["PORTUGUESE",586]="${pending_of_translation} ${blue_color}Isso desabilitará o mostrar conselhos. ${green_color}Você deseja continuar? ${normal_color}${visual_choice}"
	arr["RUSSIAN",586]="${pending_of_translation} ${blue_color}Он отключит шоу-рекомендации. ${green_color}Вы хотите продолжить? ${normal_color}${visual_choice}"
	...
	arr["ITALIAN",586]="${pending_of_translation} ${blue_color}Disabilita i consigli sullo spettacolo ${green_color}Vuoi continuare? ${normal_color}${visual_choice}"
	...
	arr["GERMAN",586]="${pending_of_translation} ${blue_color}Der Show-Hinweis wird deaktiviert. ${green_color}Wollen Sie weitermachen? ${normal_color}${visual_choice}"
	...
	arr["FRENCH",587]="${pending_of_translation} ${blue_color}Il permettra aux conseils de spectacle. ${green_color}Voulez-vous continuer? ${normal_color}${visual_choice}"
	arr["CATALAN",587]="${pending_of_translation} ${blue_color}Es va a habilitar mostrar consells. ${green_color}¿Vols continuar? ${normal_color}${visual_choice}"
	arr["PORTUGUESE",587]="${pending_of_translation} ${blue_color}Isso permitirá mostrar conselhos. ${green_color}Você deseja continuar? ${normal_color}${visual_choice}"
	arr["RUSSIAN",587]="${pending_of_translation} ${blue_color}Это позволит показывать подсказки. ${green_color}Вы хотите продолжить? ${normal_color}${visual_choice}"
	...
	arr["ITALIAN",587]="${pending_of_translation} ${blue_color}Permetterà di mostrare suggerimenti ${green_color}Vuoi continuare? ${normal_color}${visual_choice}"
	...
	arr["GERMAN",587]="${pending_of_translation} ${blue_color}Es werden Showtipps aktiviert. ${green_color}Wollen Sie weitermachen? ${normal_color}${visual_choice}"
	...
	arr["FRENCH",588]="${pending_of_translation} Les afficher des conseils ont été désactivés"
	arr["CATALAN",588]="${pending_of_translation} S'han desactivat mostrar consells"
	arr["PORTUGUESE",588]="${pending_of_translation} Mostrar conselhos foram desativados"
	arr["RUSSIAN",588]="${pending_of_translation} Подсказки печати отключены"
	arr["GREEK",588]="${pending_of_translation} Οι συμβουλές εκτύπωσης έχουν απενεργοποιηθεί"
	arr["ITALIAN",588]="${pending_of_translation} Mostrare suggerimenti sono stati disattivati"
	arr["POLISH",588]="${pending_of_translation} Wskazówki do drukowania zostały wyłączone"
	arr["GERMAN",588]="${pending_of_translation} DHinweise zum Drucken wurden deaktiviert"
	...
	arr["FRENCH",589]="${pending_of_translation} Les afficher des conseils ont été activés"
	arr["CATALAN",589]="${pending_of_translation} S'ha activat mostrar consells"
	arr["PORTUGUESE",589]="${pending_of_translation} Mostrar conselhos foram ativados"
	arr["RUSSIAN",589]="${pending_of_translation} Подсказки печати включены"
	arr["GREEK",589]="${pending_of_translation} Οι συμβουλές εκτύπωσης έχουν ενεργοποιηθεί"
	arr["ITALIAN",589]="${pending_of_translation} Sono stati attivati mostrare suggerimenti"
	...
	arr["FRENCH",592]="${pending_of_translation} 9.  Désactiver 5Ghz de manière permanente"
	arr["CATALAN",592]="${pending_of_translation} 9.  Deshabilitar 5Ghz permanentment"
	arr["PORTUGUESE",592]="${pending_of_translation} 9.  Desativar permanentemente 5Ghz"
	arr["RUSSIAN",592]="${pending_of_translation} 9.  Отключить 5Ghz навсегда"
	arr["GREEK",592]="${pending_of_translation} 9.  Απενεργοποιήστε μόνιμα 5Ghz"
	arr["ITALIAN",592]="${pending_of_translation} 9.  Disattiva permanentemente 5Ghz"
	arr["POLISH",592]="${pending_of_translation} 9.  Wyłącz na stałe 5Ghz"
	arr["GERMAN",592]="${pending_of_translation} 9.  Deaktivieren Sie dauerhaft 5Ghz"
	...
	arr["FRENCH",593]="${pending_of_translation} 9.  Activer 5Ghz en permanence"
	arr["CATALAN",593]="${pending_of_translation} 9.  Habilitar 5Ghz permanentment"
	arr["PORTUGUESE",593]="${pending_of_translation} 9.  Ativar 5Ghz permanentemente"
	arr["RUSSIAN",593]="${pending_of_translation} 9. Включить 5Ghz на постоянной основе"
	arr["GREEK",593]="${pending_of_translation} 9.  Ενεργοποιήστε μόνιμα 5Ghz"
	arr["ITALIAN",593]="${pending_of_translation} 9.  Abilitare 5Ghz in modo permanente"
	arr["POLISH",593]="${pending_of_translation} 9.  Włącz na stałe 5Ghz"
	arr["GERMAN",593]="${pending_of_translation} 9.  5Ghz dauerhaft aktivieren"
	...
	arr["FRENCH",594]="${pending_of_translation} 5Ghz: ${pink_color}Activée${normal_color}"
	arr["CATALAN",594]="${pending_of_translation} 5Ghz: ${pink_color}Activat${normal_color}"
	arr["PORTUGUESE",594]="${pending_of_translation} 5Ghz: ${pink_color}Ativado${normal_color}"
	arr["RUSSIAN",594]="${pending_of_translation} 5Ghz: ${pink_color}Активированный${normal_color}"
	arr["GREEK",594]="${pending_of_translation} 5Ghz: ${pink_color}Ενεργοποιήθηκε${normal_color}"
	arr["ITALIAN",594]="${pending_of_translation} 5Ghz: ${pink_color}Habilitato${normal_color}"
	arr["POLISH",594]="${pending_of_translation} 5Ghz: ${pink_color}Aktywowany${normal_color}"
	arr["GERMAN",594]="${pending_of_translation} 5Ghz: ${pink_color}Aktiviert${normal_color}"
	...
	arr["FRENCH",595]="${pending_of_translation} 5Ghz: ${pink_color}Désactivé${normal_color}"
	arr["CATALAN",595]="${pending_of_translation} 5Ghz: ${pink_color}Desactivat${normal_color}"
	arr["PORTUGUESE",595]="${pending_of_translation} 5Ghz: ${pink_color}Desativado${normal_color}"
	arr["RUSSIAN",595]="${pending_of_translation} 5Ghz: ${pink_color}Дезактивированный${normal_color}"
	arr["GREEK",595]="${pending_of_translation} 5Ghz: ${pink_color}Απενεργοποιημένο${normal_color}"
	arr["ITALIAN",595]="${pending_of_translation} 5Ghz: ${pink_color}Disabilitato${normal_color}"
	arr["POLISH",595]="${pending_of_translation} 5Ghz: ${pink_color}Dezaktywowane${normal_color}"
	arr["GERMAN",595]="${pending_of_translation} 5Ghz: ${pink_color}Deaktiviert${normal_color}"
	arr["TURKISH",595]="${pending_of_translation} 5Ghz: ${pink_color}Devreden${normal_color}"
	...
	arr["FRENCH",596]="${pending_of_translation} ${blue_color}Cela désactivera 5Ghz. ${green_color}Voulez-vous continuer? ${normal_color}${visual_choice}"
	arr["CATALAN",596]="${pending_of_translation} ${blue_color}Es va a desactivar 5Ghz. ${green_color}¿Vols continuar? ${normal_color}${visual_choice}"
	arr["PORTUGUESE",596]="${pending_of_translation} ${blue_color}Isso desabilitará o 5Ghz. ${green_color}Você deseja continuar? ${normal_color}${visual_choice}"
	arr["RUSSIAN",596]="${pending_of_translation} ${blue_color}5Ghz будет отключено. ${green_color}Вы хотите продолжить? ${normal_color}${visual_choice}"
	arr["GREEK",596]="${pending_of_translation} ${blue_color}Το 5Ghz θα απενεργοποιηθεί. ${green_color}Θέλετε να συνεχίσετε; ${normal_color}${visual_choice}"
	arr["ITALIAN",596]="${pending_of_translation} ${blue_color}Disabilita 5Ghz. ${green_color}Vuoi continuare? ${normal_color}${visual_choice}"
	...
	arr["GERMAN",596]="${pending_of_translation} ${blue_color}5Ghz werden deaktiviert. ${green_color}Wollen Sie weitermachen? ${normal_color}${visual_choice}"
	arr["TURKISH",596]="${pending_of_translation} ${blue_color}5Ghz devre dışı bırakılacak. ${green_color}Devam etmek istiyor musunuz? ${normal_color}${visual_choice}"
	...
	arr["FRENCH",597]="${pending_of_translation} ${blue_color}Il permettra 5Ghz. ${green_color}Voulez-vous continuer? ${normal_color}${visual_choice}"
	arr["CATALAN",597]="${pending_of_translation} ${blue_color}Es va a habilitar 5Ghz. ${green_color}¿Vols continuar? ${normal_color}${visual_choice}"
	arr["PORTUGUESE",597]="${pending_of_translation} ${blue_color}Isso permitirá 5Ghz. ${green_color}Você deseja continuar? ${normal_color}${visual_choice}"
	arr["RUSSIAN",597]="${pending_of_translation} ${blue_color}5Ghz будет включено. ${green_color}Вы хотите продолжить? ${normal_color}${visual_choice}"
	arr["GREEK",597]="${pending_of_translation} ${blue_color}Το 5Ghz θα ενεργοποιηθεί. ${green_color}Θέλετε να συνεχίσετε; ${normal_color}${visual_choice}"
	arr["ITALIAN",597]="${pending_of_translation} ${blue_color}Permetterà 5Ghz ${green_color}Vuoi continuare? ${normal_color}${visual_choice}"
	...
	arr["GERMAN",597]="${pending_of_translation} ${blue_color}5Ghz werden aktiviert. ${green_color}Wollen Sie weitermachen? ${normal_color}${visual_choice}"
	arr["TURKISH",597]="${pending_of_translation} ${blue_color}Umożliwi to pokazywanie wskazówek. ${green_color}Devam etmek istiyor musunuz? ${normal_color}${visual_choice}"

	arr["ENGLISH",598]="5Ghz has been disabled"
	arr["SPANISH",598]="Se ha desactivado 5Ghz"
	arr["FRENCH",598]="${pending_of_translation} 5Ghz ont été désactivés"
	arr["CATALAN",598]="${pending_of_translation} S'ha desactivat 5Ghz"
	arr["PORTUGUESE",598]="${pending_of_translation} 5Ghz foram desativados"
	arr["RUSSIAN",598]="${pending_of_translation} 5Ghz отключен"
	arr["GREEK",598]="${pending_of_translation} Το 5Ghz έχει απενεργοποιηθεί"
	arr["ITALIAN",598]="${pending_of_translation} 5Ghz è stato disabilitato"
	arr["POLISH",598]="${pending_of_translation} 5Ghz zostało wyłączone"
	arr["GERMAN",598]="${pending_of_translation} 5Ghz wurde deaktiviert"
	arr["TURKISH",598]="${pending_of_translation} 5Ghz devre dışı bırakıldı"

	arr["ENGLISH",599]="5Ghz has been enabled"
	arr["SPANISH",599]="Se ha activado 5Ghz"
	arr["FRENCH",599]="${pending_of_translation} 5Ghz ont été activés"
	arr["CATALAN",599]="${pending_of_translation} S'ha activat 5Ghz"
	arr["PORTUGUESE",599]="${pending_of_translation} 5Ghz foram ativados"
	arr["RUSSIAN",599]="${pending_of_translation} 5Ghz активировано"
	arr["GREEK",599]="${pending_of_translation} Το 5Ghz έχει ενεργοποιηθεί"
	arr["ITALIAN",599]="${pending_of_translation} 5Ghz è stato abilitato"
	arr["POLISH",599]="${pending_of_translation} 5Ghz zostało włączone"
	arr["GERMAN",599]="${pending_of_translation} 5Ghz wurde aktiviert"
