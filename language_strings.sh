...
function language_strings() {
	...
	arr["SPANISH",117]="modo suave, desconectar tras capturar"
	#TODO translate this stuff
	arr["FRENCH",117]="${pending_of_translation} "
	arr["CATALAN",117]="${pending_of_translation} "
	arr["PORTUGUESE",117]="${pending_of_translation} "
	arr["RUSSIAN",117]="${pending_of_translation} "
	arr["GREEK",117]="${pending_of_translation} "
	...
	arr["ENGLISH",248]="hardcore mode, non stop"
	arr["SPANISH",248]="modo hardcore, sin interrupciones"
	#TODO translate this stuff
	arr["FRENCH",248]="${pending_of_translation} "
	arr["CATALAN",248]="${pending_of_translation} "
	arr["PORTUGUESE",248]="${pending_of_translation} "
	arr["RUSSIAN",248]="${pending_of_translation} "
	arr["GREEK",248]="${pending_of_translation} "
	...
	arr["SPANISH",260]="5.  Evil Twin Enterprise modo suave"
	arr["FRENCH",260]="${pending_of_translation} 5.  "
	arr["CATALAN",260]="${pending_of_translation} 5.  "
	arr["PORTUGUESE",260]="${pending_of_translation} 5.  "
	arr["RUSSIAN",260]="${pending_of_translation} 5.  "
	arr["GREEK",260]="${pending_of_translation} 5.  "
	arr["ITALIAN",260]="${pending_of_translation} 5.  "
	arr["POLISH",260]="${pending_of_translation} 5.  "
	arr["GERMAN",260]="${pending_of_translation} 5.  "
	arr["TURKISH",260]="${pending_of_translation} 5.  "
	...
	arr["ENGLISH",307]="6.  Hardcore mode Enterprise Evil Twin"
	arr["SPANISH",307]="6.  Evil Twin Enterprise modo hardcore"
	arr["FRENCH",307]="${pending_of_translation} 6.  "
	arr["CATALAN",307]="${pending_of_translation} 6.  "
	arr["PORTUGUESE",307]="${pending_of_translation} 6.  "
	arr["RUSSIAN",307]="${pending_of_translation} 6.  "
	arr["GREEK",307]="${pending_of_translation} 6.  "
	arr["ITALIAN",307]="${pending_of_translation} 6.  "
	arr["POLISH",307]="${pending_of_translation} 6.  "
	arr["GERMAN",307]="${pending_of_translation} 6.  "
	arr["TURKISH",307]="${pending_of_translation} 6.  "
	...
	arr["ENGLISH",332]="Before launching an attack on an Enterprise network, bear in mind that \"hardcore\" mode will cause legitimate clients stuck trying to authenticate over and over again on the fake network. This could raise suspicions and you could be easily discovered"
	arr["SPANISH",332]="Antes de lanzar un ataque contra una red Enterprise, ten en cuenta que el modo \"hardcore\" dejará a los clientes legítimos atrapados intentando autenticarse una y otra vez contra la red falsa. Esto podría levantar sospechas y podrías ser descubierto fácilmente"
	#TODO translate this stuff
	...
	arr["ENGLISH",483]="The attack in \"soft\" mode will be dismantled as soon as a credential is captured to let clients reconnect again to the legitimate network. This reduces the possibility of being discovered, looking for some users as a punctual wireless network malfunction"
	arr["SPANISH",483]="El ataque en modo \"suave\" tan pronto capture unas credenciales se desmantelará para dejar que los clientes vuelvan a conectarse a la red legítima. Esto reduce las posibilidades de ser descubierto haciendo que para algunos usuarios pueda parecer un fallo puntual de la red inalámbrica"
	#TODO translate this stuff
