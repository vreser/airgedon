...
function language_strings() {
	...
	arr["FRENCH",332]="${pending_of_translation} "
	arr["CATALAN",332]="${pending_of_translation} "
	arr["PORTUGUESE",332]="${pending_of_translation} "
	arr["RUSSIAN",332]="${pending_of_translation} "
	arr["GREEK",332]="${pending_of_translation} "
	...
	#TODO translate this stuff
	arr["FRENCH",483]="${pending_of_translation} "
	arr["CATALAN",483]="${pending_of_translation} "
	arr["PORTUGUESE",483]="${pending_of_translation} "
	arr["RUSSIAN",483]="${pending_of_translation} "
	arr["GREEK",483]="${pending_of_translation} "
	...
	#TODO translate this stuff
	arr["FRENCH",549]="${pending_of_translation} "
	arr["CATALAN",549]="${pending_of_translation} "
	arr["PORTUGUESE",549]="${pending_of_translation} "
	arr["RUSSIAN",549]="${pending_of_translation} "
	arr["GREEK",549]="${pending_of_translation} "
	arr["ITALIAN",549]="${pending_of_translation} "
	arr["POLISH",549]="${pending_of_translation} "
	arr["GERMAN",549]="${pending_of_translation} "
	arr["TURKISH",549]="${pending_of_translation} "
