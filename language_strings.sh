...
function language_strings() {
	...
	arr["ENGLISH",447]="6.  Set permanently airgeddon's language to the current one"
	arr["SPANISH",447]="6.  Cambiar permanentemente el idioma de airgeddon al actual"
	arr["FRENCH",447]="6.  Etablir comme langue permanente d'airgeddon celle utilisée actuellement"
	arr["CATALAN",447]="6.  Canviar permanentment l'idioma de airgeddon a l'actual"
	arr["PORTUGUESE",447]="6.  Alterar permanentemente o idioma do airgeddon para o atual"
	arr["RUSSIAN",447]="6.  Сделать текущий язык airgeddon постоянным"
	arr["GREEK",447]="6.  Θέστε μόνιμα την τρέχουσα γλώσσα του airgeddon ως προεπιλεγμένη"
	arr["ITALIAN",447]="6.  Modificare in modo permanente la lingua di airgeddon a quella attuale"
	arr["POLISH",447]="6.  Trwale ustaw język airgeddon na aktualny"
	arr["GERMAN",447]="6.  Ändern Sie dauerhaft die Sprache von airgeddon zur aktuellen Sprache"
	arr["TURKISH",447]="6.  Sürekli olarak airgeddon'un dilini geçerli olana ayarla"
	...
	arr["ENGLISH",450]="4.  Enable extended colorization permanently"
	arr["SPANISH",450]="4.  Habilitar permanentemente la colorización extendida"
	arr["FRENCH",450]="${pending_of_translation} 4.  Activer dé façon permanante la colorisation étendue"
	arr["CATALAN",450]="${pending_of_translation} 4.  Habilita permanentment la coloració estesa"
	arr["PORTUGUESE",450]="${pending_of_translation} 4.  Ativar permanentemente a colorização estendida"
	arr["RUSSIAN",450]="${pending_of_translation} 4.  Включить расширенную раскраску навсегда"
	arr["GREEK",450]="${pending_of_translation} 4.  Ενεργοποιήστε τον εκτεταμένο χρωματισμό μόνιμα"
	arr["ITALIAN",450]="${pending_of_translation} 4.  Abilitare permanentemente la colorazione estesa"
	arr["POLISH",450]="${pending_of_translation} 4.  Trwale włącz przedłużona kolorowanie"
	arr["GERMAN",450]="${pending_of_translation} 4.  Die erweiterte Einfärbung dauerhaft aktivieren"
	arr["TURKISH",450]="${pending_of_translation} 4.  Genişletilmiş renklendirmeyi kalıcı olarak etkinleştir"
	...
	arr["ENGLISH",456]="4.  Disable extended colorization permanently"
	arr["SPANISH",456]="4.  Deshabilitar permanentemente la colorización extendida"
	arr["FRENCH",456]="${pending_of_translation} 4.  Désactiver dé façon étendue permanante"
	arr["CATALAN",456]="${pending_of_translation} 4.  Deshabilita permanentment la coloració estesa"
	arr["PORTUGUESE",456]="${pending_of_translation} 4.  Desativar permanentemente a colorização estendida"
	arr["RUSSIAN",456]="${pending_of_translation} 4.  Постоянно отключать расширенную раскраску"
	arr["GREEK",456]="${pending_of_translation} 4.  Απενεργοποιήστε μόνιμα τον εκτεταμένο χρωματισμό"
	arr["ITALIAN",456]="${pending_of_translation} 4.  Disattivare permanentemente la colorazione estesa"
	arr["POLISH",456]="${pending_of_translation} 4.  Trwale wyłącz przedłużona kolorowanie"
	arr["GERMAN",456]="${pending_of_translation} 4.  Die erweiterte Einfärbung dauerhaft deaktivieren"
	arr["TURKISH",456]="${pending_of_translation} 4.  Genişletilmiş renklendirmeyi kalıcı olarak devre dışı bırak"
	...
	arr["ENGLISH",467]="5.  Enable startup language autodetection permanently"
	arr["SPANISH",467]="5.  Habilitar permanentemente la autodetección de idioma al inicio"
	arr["FRENCH",467]="5.  Activer de façon permanente la détection de langue au lancement"
	arr["CATALAN",467]="5.  Habilitar permanentment l'autodetecció d'idioma a l'inici"
	arr["PORTUGUESE",467]="5.  Ativar permanentemente a detecção do idioma no início"
	arr["RUSSIAN",467]="5.  Автоматическое определение языка постоянно отключено"
	arr["GREEK",467]="5.  Ενεργοποίηση του αυτόματου εντοπισμού γλώσσας κατά την εκκίνηση μόνιμα"
	arr["ITALIAN",467]="5.  Abilitare permanentemente il rilevamento automatico della lingua all'inizio"
	arr["POLISH",467]="5.  Trwale włącz automatyczne wykrywanie języka podczas uruchamiania"
	arr["GERMAN",467]="5.  Automatische Spracherkennung beim Start dauerhaft aktivieren"
	arr["TURKISH",467]="5.  Başlangıç dilini otomatik algılama özelliğini kalıcı olarak etkinleştir"

	arr["ENGLISH",468]="5.  Disable startup language autodetection permanently"
	arr["SPANISH",468]="5.  Deshabilitar permanentemente la autodetección de idioma al inicio"
	arr["FRENCH",468]="5.  Désactiver de façon permanente la détection de langue au lancement"
	arr["CATALAN",468]="5.  Deshabilitar permanentment l'autodetecció d'idioma a l'inici"
	arr["PORTUGUESE",468]="5.  Desativar permanentemente a detecção do idioma no início"
	arr["RUSSIAN",468]="5.  Постоянное отключение автоматического определения языка"
	arr["GREEK",468]="5.  Απενεργοποίηση του αυτόματου εντοπισμού γλώσσας κατά την εκκίνηση μόνιμα"
	arr["ITALIAN",468]="5.  Disattivare permanentemente il rilevamento automatico della lingua all'inizio"
	arr["POLISH",468]="5.  Trwale wyłącz autodetekcję języka podczas uruchamiania"
	arr["GERMAN",468]="5.  Automatische Spracherkennung beim Start dauerhaft deaktivieren"
	arr["TURKISH",468]="5.  Başlangıç dili otomatik algılamayı kalıcı olarak devre dışı bırak"
	...
	arr["FRENCH",556]="${pending_of_translation} 3.  Activer dé façon permanante la colorisation"
	arr["CATALAN",556]="${pending_of_translation} 3.  Habilita permanentment la coloració"
	arr["PORTUGUESE",556]="${pending_of_translation} 3.  Ativar permanentemente a colorização"
	arr["RUSSIAN",556]="${pending_of_translation} 3.  Включить раскраску навсегда"
	arr["GREEK",556]="${pending_of_translation} 3.  Ενεργοποιήστε τον χρωματισμό μόνιμα"
	arr["ITALIAN",556]="${pending_of_translation} 3.  Abilitare permanentemente la colorazione"
	arr["POLISH",556]="${pending_of_translation} 3.  Trwale włącz kolorowanie"
	arr["GERMAN",556]="${pending_of_translation} 3.  Die Einfärbung dauerhaft aktivieren"
	arr["TURKISH",556]="${pending_of_translation} 3.  Renklendirmeyi kalıcı olarak etkinleştir"

	arr["ENGLISH",557]="3.  Disable colorization permanently"
	arr["SPANISH",557]="3.  Deshabilitar permanentemente la colorización"
	arr["FRENCH",557]="${pending_of_translation} 3.  Désactiver dé façon permanante"
	arr["CATALAN",557]="${pending_of_translation} 3.  Deshabilita permanentment la coloració"
	arr["PORTUGUESE",557]="${pending_of_translation} 3.  Desativar permanentemente a colorização"
	arr["RUSSIAN",557]="${pending_of_translation} 3.  Постоянно отключать раскраску"
	arr["GREEK",557]="${pending_of_translation} 3.  Απενεργοποιήστε μόνιμα τον χρωματισμό"
	arr["ITALIAN",557]="${pending_of_translation} 3.  Disattivare permanentemente la colorazione"
	arr["POLISH",557]="${pending_of_translation} 3.  Trwale wyłącz kolorowanie"
	arr["GERMAN",557]="${pending_of_translation} 3.  Die Einfärbung dauerhaft deaktivieren"
	arr["TURKISH",557]="${pending_of_translation} 3.  Renklendirmeyi kalıcı olarak devre dışı bırak"
