...
function language_strings() {
	...
	arr["CATALAN",549]="7.  (asleap) Atac de diccionari challenge/response"
	...
	arr["CATALAN",575]="Xecs silenciosos: ${pink_color}Activats${normal_color}"
	...
	arr["CATALAN",576]="Xecs silenciosos: ${pink_color}Desactivats${normal_color}"
	...
	arr["CATALAN",577]="${blue_color}Es van a desactivar els xecs silencioses. ${green_color}¿Vols continuar? ${normal_color}${visual_choice}"
	...
	arr["CATALAN",578]="${blue_color}Es van a habilitar els xecs silencioses. ${green_color}¿Vols continuar? ${normal_color}${visual_choice}"
	...
	arr["CATALAN",579]="S'han desactivat els xecs silenciosos"
	...
	arr["CATALAN",580]="S'han activat els xecs silenciosos"
	...
	arr["CATALAN",581]="Vas llançar airgeddon amb els xecs silencioses activats. Deshabilita aquesta opció per veure quin és el problema"
