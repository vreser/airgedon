...
function language_strings_handling_messages() {
	...
	language_strings_file_mismatch["GERMAN"]="${pending_of_translation} Fehler Die gefundene Übersetzungsdatei ist nicht die erwartete Version"
	...
	language_strings_try_to_download["GERMAN"]="${pending_of_translation} airgeddon wird versuchen, die Übersetzungsdatei herunterzuladen..."
	...
	language_strings_successfully_downloaded["GERMAN"]="${pending_of_translation} Die Übersetzungsdatei wurde erfolgreich heruntergeladen"
	...
	language_strings_failed_downloading["GERMAN"]="${pending_of_translation} Die Übersetzungsdatei konnte nicht heruntergeladen werden. Überprüfen Sie Ihre Internetverbindung oder laden Sie sie manuell von ${normal_color}${urlgithub}"
	...
	language_strings_first_time["GERMAN"]="${pending_of_translation} Wenn Sie diese Nachricht nach einem automatischen Update sehen, haben Sie keine Angst! Das liegt vermutlich daran, dass ab Version 6.1 die Dateistruktur von airgeddon geändert wurde. Es wird automatisch repariert"
	...
	language_strings_exiting["GERMAN"]="${pending_of_translation} Verlassen airgeddon Skript v${airgeddon_version} - Bis bald! :)"
	...
	language_strings_key_to_continue["GERMAN"]="${pending_of_translation} Drücken Sie die [Enter]-Taste um fortzufahren..."
}
