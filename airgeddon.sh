...
function language_strings_handling_messages() {
	...
	language_strings_no_file["TURKISH"]="${pending_of_translation} Hata. Çeviri dosyası bulunamadı"
	...
	language_strings_file_mismatch["TURKISH"]="${pending_of_translation} Hata. Bulunan çeviri dosyası beklenen sürüm değil"
	...
	language_strings_try_to_download["TURKISH"]="${pending_of_translation} airgeddon çeviri dosyasını indirmeye çalışacak..."
	...
	language_strings_successfully_downloaded["TURKISH"]="${pending_of_translation} Çeviri dosyası başarıyla indirildi"
	...
	language_strings_failed_downloading["TURKISH"]="${pending_of_translation} Çeviri dosyası indirilemedi. İnternet bağlantınızı kontrol edin veya manuel olarak indirin ${normal_color}${urlgithub}"
	...
	language_strings_first_time["TURKISH"]="${pending_of_translation} Otomatik bir güncellemeden sonra bu mesajı görüyorsanız, korkmayın! muhtemelen 6.1 sürümünden itibaren airgeddon dosya yapısı değişmiştir. Otomatik olarak tamir edilecektir"
	...
	language_strings_exiting["TURKISH"]="${pending_of_translation} airgeddon komut dosyası ayrılıyor v${airgeddon_version} - Yakında görüşürüz! :)"
	...
	language_strings_key_to_continue["TURKISH"]="${pending_of_translation} Devam etmek için [Enter] tuşuna basın..."
}
